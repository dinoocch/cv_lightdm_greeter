/* user-list.c generated by valac 0.26.2, the Vala compiler
...
struct _UserListCreateRemoteFieldsForCurrentItemData {
	...
	gboolean _tmp102_;
	gboolean _tmp103_;
	RemoteServerField* _tmp104_;
	GHashTable* _tmp105_;
	RemoteServerField* _tmp106_;
	GHashTable* _tmp107_;
	gboolean _tmp108_;
	RemoteServerField* _tmp109_;
	GHashTable* _tmp110_;
...
static void __lambda52_ (UserList* self, GObject* obj, GAsyncResult* res);
...
static void __lambda51_ (Block7Data* _data7_, gint id);
static gboolean user_list_is_supported_remote_session (UserList* self, const gchar* session_internal_name);
static void ___lambda51__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self);
...
static void __user_list___lambda54__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
static void _user_list___lambda55_ (UserList* self);
static void __user_list___lambda55__greeter_list_entry_displayed_start (GreeterList* _sender, gpointer self);
static void _user_list___lambda56_ (UserList* self);
static void __user_list___lambda56__greeter_list_entry_displayed_done (GreeterList* _sender, gpointer self);
...
static void user_list_set_remote_directory_servers (UserList* self, RemoteServer* server_list, int server_list_length1) {
	...
	while (TRUE) {
		...
		found = FALSE;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					if (!_tmp27_) {
						gint _tmp28_ = 0;
						RemoteServer* _tmp29_ = NULL;
						gint _tmp29__length1 = 0;
						_tmp28_ = i;
						_tmp29_ = server_list;
						_tmp29__length1 = server_list_length1;
						_tmp26_ = _tmp28_ < _tmp29__length1;
					} else {
						_tmp26_ = FALSE;
					}
					if (!_tmp26_) {
		...
		_tmp36_ = found;
		if (!_tmp36_) {
			RemoteServer* _tmp37_ = NULL;
			const gchar* _tmp38_ = NULL;
			const gchar* _tmp39_ = NULL;
			RemoteServer* _tmp42_ = NULL;
			RemoteServer _tmp43_ = {0};
			gchar* _tmp44_ = NULL;
			gchar* _tmp45_ = NULL;
			GList* newIt = NULL;
			GList* _tmp46_ = NULL;
			...
			_tmp38_ = (*_tmp37_).url;
			_tmp39_ = self->priv->currently_browsing_server_url;
			if (g_strcmp0 (_tmp38_, _tmp39_) == 0) {
				...
				self->priv->currently_browsing_server_url = _tmp40_;
				_tmp41_ = g_strdup ("");
				_g_free0 (self->priv->currently_browsing_server_email);
				self->priv->currently_browsing_server_email = _tmp41_;
			}
			_tmp42_ = remote_server;
			_tmp43_ = *_tmp42_;
			_tmp44_ = user_list_user_list_name_for_remote_directory_server (self, &_tmp43_);
			_tmp45_ = _tmp44_;
			greeter_list_remove_entry ((GreeterList*) self, _tmp45_);
			_g_free0 (_tmp45_);
			_tmp46_ = it;
			_tmp47_ = _tmp46_->next;
			newIt = _tmp47_;
			_tmp48_ = it;
			self->priv->remote_directory_server_list = g_list_delete_link (self->priv->remote_directory_server_list, _tmp48_);
			_tmp49_ = newIt;
			it = _tmp49_;
		} else {
			GList* _tmp50_ = NULL;
	...
	_tmp53_ = self->priv->remote_directory_server_list;
	_tmp54_ = g_list_length (_tmp53_);
	if (_tmp54_ > ((guint) 0)) {
		gboolean _tmp55_ = FALSE;
		gboolean _tmp56_ = FALSE;
		_tmp55_ = greeter_list_get_always_show_manual ((GreeterList*) self);
		_tmp56_ = _tmp55_;
		_tmp52_ = !_tmp56_;
	} else {
		_tmp52_ = FALSE;
...
static void user_list_remote_login_servers_updated (UserList* self, const gchar* url, const gchar* email_address, const gchar* data_type, RemoteServer* server_list, int server_list_length1) {
	...
	if (_tmp0_) {
		RemoteServer* _tmp5_ = NULL;
		gint _tmp5__length1 = 0;
		GList* it = NULL;
		GList* _tmp16_ = NULL;
		_tmp5_ = server_list;
		_tmp5__length1 = server_list_length1;
		{
			RemoteServer* remote_server_collection = NULL;
			gint remote_server_collection_length1 = 0;
			gint _remote_server_collection_size_ = 0;
			gint remote_server_it = 0;
			remote_server_collection = _tmp5_;
			remote_server_collection_length1 = _tmp5__length1;
			for (remote_server_it = 0; remote_server_it < _tmp5__length1; remote_server_it = remote_server_it + 1) {
				RemoteServer _tmp6_ = {0};
				RemoteServer remote_server = {0};
				remote_server_copy (&remote_server_collection[remote_server_it], &_tmp6_);
				remote_server = _tmp6_;
				{
					gchar* list_name = NULL;
					RemoteServer _tmp7_ = {0};
					gchar* _tmp8_ = NULL;
					...
					_tmp7_ = remote_server;
					_tmp8_ = user_list_user_list_name_for_remote_login_server (self, &_tmp7_);
					list_name = _tmp8_;
					_tmp9_ = list_name;
					_tmp10_ = greeter_list_find_entry ((GreeterList*) self, _tmp9_);
					_tmp11_ = _tmp10_;
					...
					if (_tmp12_) {
						...
						_tmp14_ = user_list_create_prompt_for_login_server (self, &_tmp13_);
						_tmp15_ = _tmp14_;
		...
		_tmp16_ = self->priv->remote_login_server_list;
		it = _tmp16_;
		while (TRUE) {
			GList* _tmp17_ = NULL;
			RemoteServer remote_server = {0};
			...
			remote_server_copy ((RemoteServer*) _tmp19_, &_tmp20_);
			remote_server = _tmp20_;
			found = FALSE;
			{
				gint i = 0;
				i = 0;
				{
					...
					while (TRUE) {
						...
						if (!_tmp24_) {
							gint _tmp25_ = 0;
							RemoteServer* _tmp26_ = NULL;
							gint _tmp26__length1 = 0;
							_tmp25_ = i;
							_tmp26_ = server_list;
							_tmp26__length1 = server_list_length1;
							_tmp23_ = _tmp25_ < _tmp26__length1;
						} else {
							_tmp23_ = FALSE;
						}
						if (!_tmp23_) {
						...
						_tmp32_ = _tmp31_.url;
						found = g_strcmp0 (_tmp28_, _tmp32_) == 0;
					}
				}
			}
			_tmp33_ = found;
			if (!_tmp33_) {
				...
				GList* _tmp39_ = NULL;
				GList* _tmp40_ = NULL;
				_tmp34_ = remote_server;
				_tmp35_ = user_list_user_list_name_for_remote_login_server (self, &_tmp34_);
				_tmp36_ = _tmp35_;
				greeter_list_remove_entry ((GreeterList*) self, _tmp36_);
				_g_free0 (_tmp36_);
				_tmp37_ = it;
				_tmp38_ = _tmp37_->next;
				newIt = _tmp38_;
				_tmp39_ = it;
				self->priv->remote_login_server_list = g_list_delete_link (self->priv->remote_login_server_list, _tmp39_);
				_tmp40_ = newIt;
				it = _tmp40_;
			} else {
				GList* _tmp41_ = NULL;
...
static void user_list_remote_login_changed (UserList* self, const gchar* url, const gchar* email_address) {
	...
	if (_tmp0_) {
		...
		_tmp5_ = g_strdup ("");
		_g_free0 (self->priv->currently_browsing_server_url);
		self->priv->currently_browsing_server_url = _tmp5_;
		_tmp6_ = g_strdup ("");
		_g_free0 (self->priv->currently_browsing_server_email);
		self->priv->currently_browsing_server_email = _tmp6_;
		_tmp7_ = url;
		_tmp8_ = g_strconcat ("*remote_directory*", _tmp7_, NULL);
		directory_list_name = _tmp8_;
		_tmp9_ = directory_list_name;
		greeter_list_set_active_entry ((GreeterList*) self, _tmp9_);
...
static void __lambda52_ (UserList* self, GObject* obj, GAsyncResult* res) {
	...
	g_return_if_fail (res != NULL);
	{
		...
		RemoteLoginService* _tmp7_ = NULL;
		_tmp1_ = res;
		...
		self->priv->remote_login_service = _tmp4_;
		_tmp5_ = self->priv->remote_login_service;
		g_signal_connect_object (_tmp5_, "servers-updated", (GCallback) _user_list_set_remote_directory_servers_remote_login_service_servers_updated, self, 0);
		_tmp6_ = self->priv->remote_login_service;
		g_signal_connect_object (_tmp6_, "login-servers-updated", (GCallback) _user_list_remote_login_servers_updated_remote_login_service_login_servers_updated, self, 0);
		_tmp7_ = self->priv->remote_login_service;
		g_signal_connect_object (_tmp7_, "login-changed", (GCallback) _user_list_remote_login_changed_remote_login_service_login_changed, self, 0);
...
static void user_list_on_remote_login_service_appeared (UserList* self, GDBusConnection* conn, const gchar* name) {
	...
	g_async_initable_new_async (TYPE_REMOTE_LOGIN_SERVICE_PROXY, 0, NULL, ___lambda52__gasync_ready_callback, g_object_ref (self), "g-flags", 0, "g-name", "com.canonical.RemoteLogin", "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", "/com/canonical/RemoteLogin", "g-interface-name", "com.canonical.RemoteLogin", "g-interface-info", g_type_get_qdata (TYPE_REMOTE_LOGIN_SERVICE, g_quark_from_static_string ("vala-dbus-interface-info")), NULL);
}
...
"*", 0, 0, &_data_->_inner_error_);
		...
		if (_data_->_tmp23_) {
			...
			_data_->_tmp28_ = NULL;
			_data_->_tmp28_ = g_match_info_fetch (_data_->_tmp27_, 0);
			_data_->_tmp29_ = NULL;
			_data_->_tmp29_ = _data_->_tmp28_;
			_data_->_tmp30_ = NULL;
			_data_->_tmp30_ = _data_->email;
			_data_->_tmp22_ = g_strcmp0 (_data_->_tmp29_, _data_->_tmp30_) == 0;
	...
	__catch44_g_regex_error:
	{
		...
		g_debug ("user-list.vala:431: Calling email regex match failed. Error: %s", _data_->_tmp32_);
		_g_error_free0 (_data_->e);
	}
	__finally44:
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
	...
	_data_->_tmp33_ = NULL;
	_data_->_tmp33_ = greeter_list_get_selected_entry ((GreeterList*) _data_->self);
	_data_->_tmp34_ = NULL;
	_data_->_tmp34_ = _data_->_tmp33_;
	prompt_box_reset_messages (_data_->_tmp34_);
	_data_->_tmp35_ = FALSE;
	_data_->_tmp35_ = _data_->email_valid;
	if (!_data_->_tmp35_) {
		((GreeterList*) _data_->self)->will_clear = TRUE;
		_data_->_tmp36_ = NULL;
		_data_->_tmp36_ = _ ("Please enter a complete e-mail address");
		greeter_list_show_message ((GreeterList*) _data_->self, _data_->_tmp36_, TRUE);
		_data_->_tmp37_ = NULL;
		_data_->_tmp37_ = _data_->self->priv->remote_directory_server_list;
		user_list_create_remote_fields_for_current_item (_data_->self, _data_->_tmp37_, NULL, NULL);
	} else {
		_data_->login_success = FALSE;
		{
			_data_->_tmp38_ = NULL;
			_data_->_tmp38_ = greeter_list_get_selected_entry ((GreeterList*) _data_->self);
			_data_->_tmp39_ = NULL;
			_data_->_tmp39_ = _data_->_tmp38_;
			_data_->_tmp40_ = NULL;
			_data_->_tmp40_ = prompt_box_get_id (_data_->_tmp39_);
			_data_->_tmp41_ = NULL;
			...
			if (_data_->_tmp44_) {
					...
					if (g_strcmp0 (_data_->_tmp52_, "delay1") == 0) {
						...
						if (g_strcmp0 (_data_->_tmp57_, "delay2") == 0) {
							...
							if (g_strcmp0 (_data_->_tmp62_, "delay3") == 0) {
								...
								_data_->_tmp65_ = NULL;
								_data_->_tmp65_ = _data_->password_field;
								_data_->_tmp66_ = NULL;
								_data_->_tmp66_ = gtk_entry_get_text ((GtkEntry*) _data_->_tmp65_);
								_data_->_tmp67_ = NULL;
								_data_->_tmp67_ = _data_->_tmp66_;
								if (g_strcmp0 (_data_->_tmp67_, "duplicate") == 0) {
									_data_->_tmp68_ = NULL;
									_data_->_tmp69_ = 0;
									user_list_test_fill_remote_login_servers_duplicate_entries (_data_->self, &_data_->_tmp68_, &_data_->_tmp69_);
									_data_->server_list = (_vala_RemoteServer_array_free (_data_->server_list, _data_->server_list_length1), NULL);
									_data_->server_list = _data_->_tmp68_;
									_data_->server_list_length1 = _data_->_tmp69_;
									_data_->_server_list_size_ = _data_->server_list_length1;
									_data_->login_success = TRUE;
								}
							}
				...
				_data_->_tmp72_ = NULL;
				_data_->_tmp72_ = greeter_list_get_selected_entry ((GreeterList*) _data_->self);
				_data_->_tmp73_ = NULL;
				_data_->_tmp73_ = _data_->_tmp72_;
				_data_->_tmp74_ = FALSE;
				_data_->_tmp74_ = prompt_box_get_has_errors (_data_->_tmp73_);
				_data_->_tmp75_ = FALSE;
				_data_->_tmp75_ = _data_->_tmp74_;
				if (_data_->_tmp75_) {
					_data_->_tmp76_ = NULL;
					_data_->_tmp76_ = _data_->self->priv->currently_browsing_server_email;
					_data_->_tmp77_ = NULL;
					_data_->_tmp77_ = _data_->email;
					_data_->_tmp71_ = g_strcmp0 (_data_->_tmp76_, _data_->_tmp77_) == 0;
				} else {
					_data_->_tmp71_ = FALSE;
				}
				if (_data_->_tmp71_) {
					_data_->_tmp78_ = NULL;
					_data_->_tmp78_ = _data_->self->priv->currently_browsing_server_url;
					_data_->_tmp79_ = NULL;
					_data_->_tmp79_ = _data_->url;
					_data_->_tmp70_ = g_strcmp0 (_data_->_tmp78_, _data_->_tmp79_) == 0;
				} else {
				...
				_data_->_tmp80_ = NULL;
				_data_->_tmp80_ = _data_->self->priv->remote_login_service;
				_data_->_tmp81_ = NULL;
				_data_->_tmp81_ = _data_->url;
				_data_->_tmp82_ = NULL;
				_data_->_tmp82_ = _data_->email;
				_data_->_tmp83_ = NULL;
				_data_->_tmp83_ = _data_->password_field;
				_data_->_tmp84_ = NULL;
				_data_->_tmp84_ = gtk_entry_get_text ((GtkEntry*) _data_->_tmp83_);
				_data_->_tmp85_ = NULL;
				_data_->_tmp85_ = _data_->_tmp84_;
				_data_->_tmp86_ = FALSE;
				_data_->_tmp86_ = _data_->allowcache;
				_data_->_tmp87_ = FALSE;
				_data_->_tmp88_ = NULL;
				_data_->_tmp89_ = NULL;
				_data_->_tmp90_ = 0;
				_data_->_state_ = 1;
				remote_login_service_get_servers_for_login (_data_->_tmp80_, _data_->_tmp81_, _data_->_tmp82_, _data_->_tmp85_, _data_->_tmp86_, user_list_remote_directory_respond_cb_ready, _data_);
				return FALSE;
				_state_1:
				remote_login_service_get_servers_for_login_finish (_data_->_tmp80_, _data_->_res_, &_data_->_tmp87_, &_data_->_tmp88_, &_data_->_tmp89_, &_data_->_tmp90_, &_data_->_inner_error_);
				_data_->login_success = _data_->_tmp87_;
				_g_free0 (_data_->data_type);
				_data_->data_type = _data_->_tmp88_;
				_data_->server_list = (_vala_RemoteServer_array_free (_data_->server_list, _data_->server_list_length1), NULL);
				_data_->server_list = _data_->_tmp89_;
				_data_->server_list_length1 = _data_->_tmp90_;
				_data_->_server_list_size_ = _data_->server_list_length1;
				if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
					_g_free0 (_data_->data_type);
					_g_free0 (_data_->url);
			...
			_g_free0 (_data_->self->priv->currently_browsing_server_url);
			_data_->self->priv->currently_browsing_server_url = _data_->_tmp92_;
			_data_->_tmp93_ = NULL;
			_data_->_tmp93_ = _data_->email;
			_data_->_tmp94_ = NULL;
			_data_->_tmp94_ = g_strdup (_data_->_tmp93_);
			_g_free0 (_data_->self->priv->currently_browsing_server_email);
			_data_->self->priv->currently_browsing_server_email = _data_->_tmp94_;
			_g_free0 (_data_->url);
		}
		goto __finally45;
...
"bus service failed. Error: %s", _data_->_tmp96_);
		...
		_data_->_tmp97_ = _data_->login_success;
		if (_data_->_tmp97_) {
			_data_->_tmp98_ = NULL;
			_data_->_tmp98_ = _data_->password_field;
			dash_entry_set_did_respond (_data_->_tmp98_, FALSE);
			_data_->_tmp99_ = NULL;
			_data_->_tmp99__length1 = 0;
			_data_->_tmp99_ = _data_->server_list;
			_data_->_tmp99__length1 = _data_->server_list_length1;
			if (_data_->_tmp99__length1 == 0) {
				user_list_show_remote_account_dialog (_data_->self);
			} else {
				_data_->_tmp100_ = NULL;
				_data_->_tmp100_ = g_strdup ("");
				_data_->last_used_server_list_name = _data_->_tmp100_;
				_data_->_tmp101_ = NULL;
				_data_->_tmp101__length1 = 0;
				_data_->_tmp101_ = _data_->server_list;
				_data_->_tmp101__length1 = _data_->server_list_length1;
				{
					_data_->remote_server_collection_length1 = 0;
					_data_->_remote_server_collection_size_ = 0;
					_data_->remote_server_collection = _data_->_tmp101_;
					_data_->remote_server_collection_length1 = _data_->_tmp101__length1;
					for (_data_->remote_server_it = 0; _data_->remote_server_it < _data_->_tmp101__length1; _data_->remote_server_it = _data_->remote_server_it + 1) {
						memset (&_data_->_tmp102_, 0, sizeof (RemoteServer));
						remote_server_copy (&_data_->remote_server_collection[_data_->remote_server_it], &_data_->_tmp102_);
						_data_->remote_server = _data_->_tmp102_;
						{
							memset (&_data_->_tmp103_, 0, sizeof (RemoteServer));
							_data_->_tmp103_ = _data_->remote_server;
							_data_->_tmp104_ = NULL;
							_data_->_tmp104_ = user_list_create_prompt_for_login_server (_data_->self, &_data_->_tmp103_);
							_data_->_vala2_e = _data_->_tmp104_;
							memset (&_data_->_tmp105_, 0, sizeof (RemoteServer));
							_data_->_tmp105_ = _data_->remote_server;
							_data_->_tmp106_ = FALSE;
							_data_->_tmp106_ = _data_->_tmp105_.last_used_server;
							if (_data_->_tmp106_) {
								_data_->_tmp107_ = NULL;
								_data_->_tmp107_ = _data_->_vala2_e;
								_data_->_tmp108_ = NULL;
								_data_->_tmp108_ = prompt_box_get_id (_data_->_tmp107_);
								...
								_data_->last_used_server_list_name = _data_->_tmp110_;
							}
				...
				_data_->_tmp111_ = _data_->last_used_server_list_name;
				if (g_strcmp0 (_data_->_tmp111_, "") != 0) {
					_data_->_tmp112_ = NULL;
					_data_->_tmp112_ = _data_->last_used_server_list_name;
					greeter_list_set_active_entry ((GreeterList*) _data_->self, _data_->_tmp112_);
				} else {
			...
			_data_->_tmp113_ = _ ("Incorrect e-mail address or password");
			greeter_list_show_message ((GreeterList*) _data_->self, _data_->_tmp113_, TRUE);
			_data_->_tmp114_ = NULL;
			_data_->_tmp114_ = _data_->self->priv->remote_directory_server_list;
			user_list_create_remote_fields_for_current_item (_data_->self, _data_->_tmp114_, NULL, NULL);
		}
	}
	_g_free0 (_data_->email);
	_data_->server_list = (_vala_RemoteServer_array_free (_data_->server_list, _data_->server_list_length1), NULL);
...
"s.canonical.com to set up an account.");
	...
	g_signal_connect_data ((GtkDialog*) _tmp22_, "response", (GCallback) ___lambda51__gtk_dialog_response, block7_data_ref (_data7_), (GClosureNotify) block7_data_unref, 0);
...
static gboolean user_list_change_background_timeout_cb (UserList* self) {
	...
	if (_tmp0_) {
		...
		_tmp7_ = _tmp6_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp7_, TYPE_USER_PROMPT_BOX)) {
			...
			_tmp9_ = _tmp8_;
			_tmp10_ = (G_TYPE_CHECK_INSTANCE_TYPE (_tmp9_, TYPE_USER_PROMPT_BOX) ? ((UserPromptBox*) _tmp9_) : NULL)->background;
			_tmp11_ = g_strdup (_tmp10_);
			_g_free0 (new_background_file);
			new_background_file = _tmp11_;
		}
	}
	_tmp12_ = greeter_list_get_background ((GreeterList*) self);
	_tmp13_ = _tmp12_;
	_tmp14_ = new_background_file;
	background_set_current_background (_tmp13_, _tmp14_);
...
gint user_list_user_list_compare_entry (PromptBox* a, PromptBox* b) {
	...
	_tmp12_ = _tmp11_;
	_tmp13_ = g_str_has_prefix (_tmp12_, "*remote_login");
	if (_tmp13_) {
		PromptBox* _tmp14_ = NULL;
		const gchar* _tmp15_ = NULL;
		const gchar* _tmp16_ = NULL;
		...
		_tmp16_ = _tmp15_;
		_tmp17_ = g_str_has_prefix (_tmp16_, "*remote_login");
		_tmp9_ = !_tmp17_;
	} else {
		_tmp9_ = FALSE;
	}
	...
	_tmp18_ = a;
	_tmp19_ = b;
	_tmp20_ = greeter_list_compare_entry (_tmp18_, _tmp19_);
	result = _tmp20_;
	return result;
}
...
static gint __lambda1_ (Block8Data* _data8_, gconstpointer** a, gconstpointer** b) {
	GPtrArray* self;
	gint result = 0;
...
static void vala_g_ptr_array_sort (GPtrArray* self, GCompareFunc compare_func) {
	...
	g_ptr_array_sort_with_data (self, ___lambda1__gcompare_data_func, _data8_);
	...
	_data_->_tmp13_ = _data_->server_list;
	{
		...
		for (_data_->remote_server_it = _data_->remote_server_collection; _data_->remote_server_it != NULL; _data_->remote_server_it = _data_->remote_server_it->next) {
			...
			_data_->remote_server = _data_->_tmp14_;
			{
				...
				if (_data_->_tmp18_) {
					_data_->_tmp26_ = NULL;
					_data_->_tmp26_ = greeter_list_get_selected_entry ((GreeterList*) _data_->self);
					_data_->_tmp27_ = NULL;
					_data_->_tmp27_ = _data_->_tmp26_;
					_data_->_tmp28_ = NULL;
					_data_->_tmp28_ = prompt_box_get_id (_data_->_tmp27_);
					_data_->_tmp29_ = NULL;
					_data_->_tmp29_ = _data_->_tmp28_;
					_data_->_tmp30_ = FALSE;
					_data_->_tmp30_ = g_str_has_prefix (_data_->_tmp29_, "*remote_login");
					if (_data_->_tmp30_) {
						_data_->_tmp31_ = NULL;
						...
						_data_->_tmp33_ = user_list_is_supported_remote_session (_data_->self, _data_->_tmp32_);
						if (!_data_->_tmp33_) {
							_data_->_tmp34_ = NULL;
							_data_->_tmp34_ = _ ("Server type not supported.");
							greeter_list_show_message ((GreeterList*) _data_->self, _data_->_tmp34_, TRUE);
						}
					}
					_data_->fields = NULL;
					_data_->_tmp35_ = NULL;
					_data_->_tmp35_ = _data_->remote_server;
					_data_->_tmp36_ = NULL;
					_data_->_tmp36__length1 = 0;
					_data_->_tmp36_ = (*_data_->_tmp35_).fields;
					_data_->_tmp36__length1 = (*_data_->_tmp35_).fields_length1;
					{
						_data_->field_collection_length1 = 0;
						_data_->_field_collection_size_ = 0;
						_data_->field_collection = _data_->_tmp36_;
						_data_->field_collection_length1 = _data_->_tmp36__length1;
						for (_data_->field_it = 0; _data_->field_it < _data_->_tmp36__length1; _data_->field_it = _data_->field_it + 1) {
							memset (&_data_->_tmp37_, 0, sizeof (RemoteServerField));
							remote_server_field_copy (&_data_->field_collection[_data_->field_it], &_data_->_tmp37_);
							_data_->field = _data_->_tmp37_;
							{
								memset (&_data_->_tmp38_, 0, sizeof (RemoteServerField));
								_data_->_tmp38_ = _data_->field;
								memset (&_data_->_tmp39_, 0, sizeof (RemoteServerField));
								_data_->_tmp39_ = _data_->_tmp38_;
								_data_->_tmp40_ = NULL;
								_data_->_tmp40_ = _remote_server_field_dup0 (&_data_->_tmp39_);
								_data_->fields = g_list_append (_data_->fields, _data_->_tmp40_);
					...
					_data_->_tmp41_ = NULL;
					_data_->_tmp41_ = _data_->fields;
					{
						_data_->_vala1_field_collection = _data_->_tmp41_;
						for (_data_->_vala1_field_it = _data_->_vala1_field_collection; _data_->_vala1_field_it != NULL; _data_->_vala1_field_it = _data_->_vala1_field_it->next) {
							_data_->_tmp42_ = NULL;
							_data_->_tmp42_ = _remote_server_field_dup0 ((RemoteServerField*) _data_->_vala1_field_it->data);
							_data_->_vala1_field = _data_->_tmp42_;
							{
								_data_->widget = NULL;
								_data_->_tmp43_ = NULL;
								_data_->_tmp43_ = g_strdup ("");
								_data_->default_value = _data_->_tmp43_;
								_data_->_tmp45_ = NULL;
								_data_->_tmp45_ = _data_->_vala1_field;
								_data_->_tmp46_ = NULL;
								_data_->_tmp46_ = (*_data_->_tmp45_).default_value;
								if (_data_->_tmp46_ != NULL) {
									...
									_data_->_tmp49_ = NULL;
									_data_->_tmp49_ = G_VARIANT_TYPE_STRING;
									_data_->_tmp50_ = FALSE;
									_data_->_tmp50_ = g_variant_is_of_type (_data_->_tmp48_, _data_->_tmp49_);
								...
								if (_data_->_tmp44_) {
									...
									_data_->_tmp52_ = NULL;
									_data_->_tmp52_ = (*_data_->_tmp51_).default_value;
									_data_->_tmp53_ = NULL;
									...
									_data_->default_value = _data_->_tmp54_;
								}
								_data_->_tmp55_ = NULL;
								_data_->_tmp55_ = _data_->_vala1_field;
								_data_->_tmp56_ = NULL;
								_data_->_tmp56_ = (*_data_->_tmp55_).type;
								if (g_strcmp0 (_data_->_tmp56_, "username") == 0) {
									_data_->_tmp57_ = NULL;
									_data_->_tmp57_ = _ ("Username:");
									_data_->_tmp58_ = NULL;
									_data_->_tmp58_ = greeter_list_add_prompt ((GreeterList*) _data_->self, _data_->_tmp57_, FALSE);
									_data_->entry = _data_->_tmp58_;
									_data_->_tmp59_ = NULL;
									_data_->_tmp59_ = _data_->entry;
									_data_->_tmp60_ = NULL;
									_data_->_tmp60_ = _data_->default_value;
									gtk_entry_set_text ((GtkEntry*) _data_->_tmp59_, _data_->_tmp60_);
									_data_->_tmp61_ = NULL;
									_data_->_tmp61_ = _data_->entry;
									_data_->_tmp62_ = NULL;
									_data_->_tmp62_ = _g_object_ref0 ((GtkWidget*) _data_->_tmp61_);
									_g_object_unref0 (_data_->widget);
									_data_->widget = _data_->_tmp62_;
									_g_object_unref0 (_data_->entry);
								} else {
									_data_->_tmp63_ = NULL;
									_data_->_tmp63_ = _data_->_vala1_field;
									_data_->_tmp64_ = NULL;
									_data_->_tmp64_ = (*_data_->_tmp63_).type;
									if (g_strcmp0 (_data_->_tmp64_, "password") == 0) {
										_data_->_tmp65_ = NULL;
										_data_->_tmp65_ = _ ("Password:");
										_data_->_tmp66_ = NULL;
										_data_->_tmp66_ = greeter_list_add_prompt ((GreeterList*) _data_->self, _data_->_tmp65_, TRUE);
										_data_->_vala1_entry = _data_->_tmp66_;
										_data_->_tmp67_ = NULL;
										_data_->_tmp67_ = _data_->_vala1_entry;
										_data_->_tmp68_ = NULL;
										_data_->_tmp68_ = _data_->default_value;
										gtk_entry_set_text ((GtkEntry*) _data_->_tmp67_, _data_->_tmp68_);
										_data_->_tmp69_ = NULL;
										_data_->_tmp69_ = _data_->_vala1_entry;
										_data_->_tmp70_ = NULL;
										_data_->_tmp70_ = _g_object_ref0 ((GtkWidget*) _data_->_tmp69_);
										_g_object_unref0 (_data_->widget);
										_data_->widget = _data_->_tmp70_;
										_g_object_unref0 (_data_->_vala1_entry);
									} else {
										_data_->_tmp71_ = NULL;
										_data_->_tmp71_ = _data_->_vala1_field;
										_data_->_tmp72_ = NULL;
										_data_->_tmp72_ = (*_data_->_tmp71_).type;
										if (g_strcmp0 (_data_->_tmp72_, "domain") == 0) {
											_data_->_tmp73_ = NULL;
											_data_->_tmp73_ = g_new0 (gchar*, 0 + 1);
											_data_->domainsArray_length1 = 0;
											_data_->_domainsArray_size_ = 0;
											_data_->domainsArray = _data_->_tmp73_;
											_data_->domainsArray_length1 = 0;
											_data_->_domainsArray_size_ = _data_->domainsArray_length1;
											_data_->_tmp76_ = NULL;
											_data_->_tmp76_ = _data_->_vala1_field;
											_data_->_tmp77_ = NULL;
											_data_->_tmp77_ = (*_data_->_tmp76_).properties;
											if (_data_->_tmp77_ != NULL) {
												...
												_data_->_tmp80_ = g_hash_table_contains (_data_->_tmp79_, "domains");
												_data_->_tmp75_ = _data_->_tmp80_;
											} else {
												_data_->_tmp75_ = FALSE;
											}
											if (_data_->_tmp75_) {
												...
												_data_->_tmp83_ = NULL;
												_data_->_tmp83_ = g_hash_table_lookup (_data_->_tmp82_, "domains");
												_data_->_tmp84_ = NULL;
												_data_->_tmp84_ = G_VARIANT_TYPE_ARRAY;
												_data_->_tmp85_ = FALSE;
												_data_->_tmp85_ = g_variant_is_of_type ((GVariant*) _data_->_tmp83_, _data_->_tmp84_);
												_data_->_tmp74_ = _data_->_tmp85_;
											} else {
												_data_->_tmp74_ = FALSE;
											}
											if (_data_->_tmp74_) {
												_data_->_tmp86_ = NULL;
												_data_->_tmp86_ = _data_->_vala1_field;
												_data_->_tmp87_ = NULL;
												_data_->_tmp87_ = (*_data_->_tmp86_).properties;
												_data_->_tmp88_ = NULL;
												_data_->_tmp88_ = g_hash_table_lookup (_data_->_tmp87_, "domains");
												memset (&_data_->_tmp89_, 0, sizeof (size_t));
												_data_->_tmp90_ = NULL;
												_data_->_tmp90_ = g_variant_dup_strv ((GVariant*) _data_->_tmp88_, &_data_->_tmp89_);
												_data_->domainsArray = (_vala_array_free (_data_->domainsArray, _data_->domainsArray_length1, (GDestroyNotify) g_free), NULL);
												_data_->domainsArray = _data_->_tmp90_;
												_data_->domainsArray_length1 = _data_->_tmp89_;
												_data_->_domainsArray_size_ = _data_->domainsArray_length1;
											}
											_data_->_tmp91_ = NULL;
											_data_->_tmp91_ = g_ptr_array_new_full ((guint) 0, _g_free0_);
											_data_->domains = _data_->_tmp91_;
											{
												_data_->i = 0;
												{
													_data_->_tmp92_ = TRUE;
													while (TRUE) {
														if (!_data_->_tmp92_) {
															...
															_data_->i = _data_->_tmp93_ + 1;
														}
														_data_->_tmp92_ = FALSE;
														_data_->_tmp94_ = 0;
														_data_->_tmp94_ = _data_->i;
														_data_->_tmp95_ = NULL;
														_data_->_tmp95__length1 = 0;
														_data_->_tmp95_ = _data_->domainsArray;
														_data_->_tmp95__length1 = _data_->domainsArray_length1;
														if (!(_data_->_tmp94_ < _data_->_tmp95__length1)) {
															break;
														}
														_data_->_tmp96_ = NULL;
														_data_->_tmp96_ = _data_->domains;
														_data_->_tmp97_ = NULL;
														_data_->_tmp97__length1 = 0;
														_data_->_tmp97_ = _data_->domainsArray;
														_data_->_tmp97__length1 = _data_->domainsArray_length1;
														_data_->_tmp98_ = 0;
														_data_->_tmp98_ = _data_->i;
														_data_->_tmp99_ = NULL;
														_data_->_tmp99_ = _data_->_tmp97_[_data_->_tmp98_];
														_data_->_tmp100_ = NULL;
														_data_->_tmp100_ = g_strdup (_data_->_tmp99_);
														g_ptr_array_add (_data_->_tmp96_, _data_->_tmp100_);
													}
												}
											}
											_data_->_tmp104_ = NULL;
											_data_->_tmp104_ = _data_->_vala1_field;
											_data_->_tmp105_ = NULL;
											_data_->_tmp105_ = (*_data_->_tmp104_).properties;
											if (_data_->_tmp105_ != NULL) {
												_data_->_tmp106_ = NULL;
												_data_->_tmp106_ = _data_->_vala1_field;
												_data_->_tmp107_ = NULL;
												_data_->_tmp107_ = (*_data_->_tmp106_).properties;
												_data_->_tmp108_ = FALSE;
												_data_->_tmp108_ = g_hash_table_contains (_data_->_tmp107_, "read-only");
												_data_->_tmp103_ = _data_->_tmp108_;
											} else {
												_data_->_tmp103_ = FALSE;
											}
											if (_data_->_tmp103_) {
												_data_->_tmp109_ = NULL;
												_data_->_tmp109_ = _data_->_vala1_field;
												_data_->_tmp110_ = NULL;
												_data_->_tmp110_ = (*_data_->_tmp109_).properties;
												_data_->_tmp111_ = NULL;
												_data_->_tmp111_ = g_hash_table_lookup (_data_->_tmp110_, "read-only");
												_data_->_tmp112_ = NULL;
												_data_->_tmp112_ = G_VARIANT_TYPE_BOOLEAN;
												_data_->_tmp113_ = FALSE;
												_data_->_tmp113_ = g_variant_is_of_type ((GVariant*) _data_->_tmp111_, _data_->_tmp112_);
												_data_->_tmp102_ = _data_->_tmp113_;
											} else {
												_data_->_tmp102_ = FALSE;
											}
											if (_data_->_tmp102_) {
												_data_->_tmp114_ = NULL;
												_data_->_tmp114_ = _data_->_vala1_field;
												_data_->_tmp115_ = NULL;
												_data_->_tmp115_ = (*_data_->_tmp114_).properties;
												_data_->_tmp116_ = NULL;
												_data_->_tmp116_ = g_hash_table_lookup (_data_->_tmp115_, "read-only");
												_data_->_tmp117_ = FALSE;
												_data_->_tmp117_ = g_variant_get_boolean ((GVariant*) _data_->_tmp116_);
												_data_->_tmp101_ = _data_->_tmp117_;
											} else {
												_data_->_tmp101_ = FALSE;
											}
											_data_->read_only = _data_->_tmp101_;
											_data_->_tmp119_ = NULL;
											_data_->_tmp119_ = _data_->domains;
											_data_->_tmp120_ = 0;
											_data_->_tmp120_ = g_ptr_array_get_length (_data_->_tmp119_);
											_data_->_tmp121_ = 0;
											_data_->_tmp121_ = _data_->_tmp120_;
											if (_data_->_tmp121_ == 0) {
												_data_->_tmp118_ = TRUE;
											} else {
												_data_->_tmp123_ = NULL;
												_data_->_tmp123_ = _data_->domains;
												_data_->_tmp124_ = 0;
												_data_->_tmp124_ = g_ptr_array_get_length (_data_->_tmp123_);
												_data_->_tmp125_ = 0;
												_data_->_tmp125_ = _data_->_tmp124_;
												if (_data_->_tmp125_ == 1) {
													_data_->_tmp127_ = NULL;
													_data_->_tmp127_ = _data_->domains;
													_data_->_tmp128_ = NULL;
													_data_->_tmp128_ = g_ptr_array_index (_data_->_tmp127_, (guint) 0);
													_data_->_tmp129_ = NULL;
													_data_->_tmp129_ = _data_->default_value;
													if (g_strcmp0 ((const gchar*) _data_->_tmp128_, _data_->_tmp129_) == 0) {
														_data_->_tmp126_ = TRUE;
													} else {
														_data_->_tmp130_ = NULL;
														_data_->_tmp130_ = _data_->default_value;
														_data_->_tmp131_ = 0;
														_data_->_tmp131_ = strlen (_data_->_tmp130_);
														_data_->_tmp132_ = 0;
														_data_->_tmp132_ = _data_->_tmp131_;
														_data_->_tmp126_ = _data_->_tmp132_ == 0;
													}
													_data_->_tmp122_ = _data_->_tmp126_;
												} else {
													_data_->_tmp122_ = FALSE;
												}
												_data_->_tmp118_ = _data_->_tmp122_;
											}
											if (_data_->_tmp118_) {
												_data_->_tmp133_ = NULL;
												_data_->_tmp133_ = _ ("Domain:");
												_data_->_tmp134_ = NULL;
												_data_->_tmp134_ = greeter_list_add_prompt ((GreeterList*) _data_->self, _data_->_tmp133_, FALSE);
												_data_->prompt = _data_->_tmp134_;
												_data_->_tmp136_ = NULL;
												_data_->_tmp136_ = _data_->domains;
												_data_->_tmp137_ = 0;
												_data_->_tmp137_ = g_ptr_array_get_length (_data_->_tmp136_);
												_data_->_tmp138_ = 0;
												_data_->_tmp138_ = _data_->_tmp137_;
												if (_data_->_tmp138_ == 1) {
													_data_->_tmp139_ = NULL;
													_data_->_tmp139_ = _data_->domains;
													_data_->_tmp140_ = NULL;
													_data_->_tmp140_ = g_ptr_array_index (_data_->_tmp139_, (guint) 0);
													_data_->_tmp135_ = (const gchar*) _data_->_tmp140_;
												} else {
													_data_->_tmp141_ = NULL;
													_data_->_tmp141_ = _data_->default_value;
													_data_->_tmp135_ = _data_->_tmp141_;
												}
												_data_->_tmp142_ = NULL;
												_data_->_tmp142_ = _data_->prompt;
												gtk_entry_set_text ((GtkEntry*) _data_->_tmp142_, _data_->_tmp135_);
												_data_->_tmp143_ = NULL;
												_data_->_tmp143_ = _data_->prompt;
												_data_->_tmp144_ = FALSE;
												_data_->_tmp144_ = _data_->read_only;
												gtk_widget_set_sensitive ((GtkWidget*) _data_->_tmp143_, !_data_->_tmp144_);
												_data_->_tmp145_ = NULL;
												_data_->_tmp145_ = _data_->prompt;
												_data_->_tmp146_ = NULL;
												_data_->_tmp146_ = _g_object_ref0 ((GtkWidget*) _data_->_tmp145_);
												_g_object_unref0 (_data_->widget);
												_data_->widget = _data_->_tmp146_;
												_g_object_unref0 (_data_->prompt);
											} else {
												_data_->_tmp147_ = NULL;
												_data_->_tmp147_ = _data_->default_value;
												_data_->_tmp148_ = 0;
												_data_->_tmp148_ = strlen (_data_->_tmp147_);
												_data_->_tmp149_ = 0;
												_data_->_tmp149_ = _data_->_tmp148_;
												if (_data_->_tmp149_ > 0) {
													_data_->found = FALSE;
													{
														_data_->_vala1_i = 0;
														{
															_data_->_tmp150_ = TRUE;
															while (TRUE) {
																if (!_data_->_tmp150_) {
																	_data_->_tmp151_ = 0;
																	_data_->_tmp151_ = _data_->_vala1_i;
																	_data_->_vala1_i = _data_->_tmp151_ + 1;
																}
																_data_->_tmp150_ = FALSE;
																_data_->_tmp153_ = FALSE;
																_data_->_tmp153_ = _data_->found;
																if (!_data_->_tmp153_) {
																	_data_->_tmp154_ = 0;
																	_data_->_tmp154_ = _data_->_vala1_i;
																	_data_->_tmp155_ = NULL;
																	_data_->_tmp155_ = _data_->domains;
																	_data_->_tmp156_ = 0;
																	_data_->_tmp156_ = g_ptr_array_get_length (_data_->_tmp155_);
																	_data_->_tmp157_ = 0;
																	_data_->_tmp157_ = _data_->_tmp156_;
																	_data_->_tmp152_ = _data_->_tmp154_ < _data_->_tmp157_;
																} else {
																...
																_data_->_tmp158_ = _data_->default_value;
																_data_->_tmp159_ = NULL;
																_data_->_tmp159_ = _data_->domains;
																_data_->_tmp160_ = 0;
																_data_->_tmp160_ = _data_->_vala1_i;
																_data_->_tmp161_ = NULL;
																_data_->_tmp161_ = g_ptr_array_index (_data_->_tmp159_, (guint) _data_->_tmp160_);
																_data_->found = g_strcmp0 (_data_->_tmp158_, (const gchar*) _data_->_tmp161_) == 0;
															}
														}
													}
													_data_->_tmp162_ = FALSE;
													_data_->_tmp162_ = _data_->found;
													if (!_data_->_tmp162_) {
														_data_->_tmp163_ = NULL;
														_data_->_tmp163_ = _data_->domains;
														_data_->_tmp164_ = NULL;
														_data_->_tmp164_ = _data_->default_value;
														_data_->_tmp165_ = NULL;
														_data_->_tmp165_ = g_strdup (_data_->_tmp164_);
														g_ptr_array_add (_data_->_tmp163_, _data_->_tmp165_);
													}
												}
												_data_->_tmp166_ = NULL;
												_data_->_tmp166_ = _data_->domains;
												_data_->_tmp167_ = NULL;
												_data_->_tmp167_ = g_strcmp0;
												vala_g_ptr_array_sort (_data_->_tmp166_, _data_->_tmp167_);
												_data_->_tmp168_ = NULL;
												_data_->_tmp168_ = _data_->domains;
												_data_->_tmp169_ = FALSE;
												_data_->_tmp169_ = _data_->read_only;
												_data_->_tmp170_ = NULL;
												_data_->_tmp170_ = greeter_list_add_combo ((GreeterList*) _data_->self, _data_->_tmp168_, _data_->_tmp169_);
												_data_->combo = _data_->_tmp170_;
												_data_->_tmp171_ = NULL;
												_data_->_tmp171_ = _data_->default_value;
												_data_->_tmp172_ = 0;
												_data_->_tmp172_ = strlen (_data_->_tmp171_);
												_data_->_tmp173_ = 0;
												_data_->_tmp173_ = _data_->_tmp172_;
												if (_data_->_tmp173_ > 0) {
													_data_->_tmp174_ = FALSE;
													_data_->_tmp174_ = _data_->read_only;
													if (_data_->_tmp174_) {
														{
															_data_->_vala2_i = 0;
															{
																_data_->_tmp175_ = TRUE;
																while (TRUE) {
																	if (!_data_->_tmp175_) {
																		_data_->_tmp176_ = 0;
																		_data_->_tmp176_ = _data_->_vala2_i;
																		_data_->_vala2_i = _data_->_tmp176_ + 1;
																	}
																	_data_->_tmp175_ = FALSE;
																	_data_->_tmp177_ = 0;
																	_data_->_tmp177_ = _data_->_vala2_i;
																	_data_->_tmp178_ = NULL;
																	_data_->_tmp178_ = _data_->domains;
																	_data_->_tmp179_ = 0;
																	_data_->_tmp179_ = g_ptr_array_get_length (_data_->_tmp178_);
																	_data_->_tmp180_ = 0;
																	_data_->_tmp180_ = _data_->_tmp179_;
																	if (!(_data_->_tmp177_ < _data_->_tmp180_)) {
																		break;
																	}
																	_data_->_tmp181_ = NULL;
																	_data_->_tmp181_ = _data_->default_value;
																	_data_->_tmp182_ = NULL;
																	_data_->_tmp182_ = _data_->domains;
																	_data_->_tmp183_ = 0;
																	_data_->_tmp183_ = _data_->_vala2_i;
																	_data_->_tmp184_ = NULL;
																	_data_->_tmp184_ = g_ptr_array_index (_data_->_tmp182_, (guint) _data_->_tmp183_);
																	if (g_strcmp0 (_data_->_tmp181_, (const gchar*) _data_->_tmp184_) == 0) {
																		_data_->_tmp185_ = NULL;
																		_data_->_tmp185_ = _data_->combo;
																		_data_->_tmp186_ = 0;
																		_data_->_tmp186_ = _data_->_vala2_i;
																		gtk_combo_box_set_active (_data_->_tmp185_, _data_->_tmp186_);
																		break;
																	}
																}
															}
														...
														_data_->_tmp187_ = _data_->combo;
														_data_->_tmp188_ = NULL;
														_data_->_tmp188_ = gtk_bin_get_child ((GtkBin*) _data_->_tmp187_);
														_data_->_tmp189_ = NULL;
														_data_->_tmp189_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp188_, gtk_entry_get_type ()) ? ((GtkEntry*) _data_->_tmp188_) : NULL);
														_data_->_vala2_entry = _data_->_tmp189_;
														_data_->_tmp190_ = NULL;
														_data_->_tmp190_ = _data_->_vala2_entry;
														_data_->_tmp191_ = NULL;
														_data_->_tmp191_ = _data_->default_value;
														gtk_entry_set_text (_data_->_tmp190_, _data_->_tmp191_);
														_g_object_unref0 (_data_->_vala2_entry);
													}
												}
												_data_->_tmp192_ = NULL;
												_data_->_tmp192_ = _data_->combo;
												_data_->_tmp193_ = NULL;
												_data_->_tmp193_ = _g_object_ref0 ((GtkWidget*) _data_->_tmp192_);
												_g_object_unref0 (_data_->widget);
												_data_->widget = _data_->_tmp193_;
											...
											if (g_strcmp0 (_data_->_tmp195_, "email") == 0) {
												_data_->email_domains_length1 = 0;
												_data_->_email_domains_size_ = 0;
												{
													_data_->_tmp196_ = NULL;
													_data_->_tmp196_ = unity_greeter_singleton;
													_data_->_tmp197_ = FALSE;
													_data_->_tmp197_ = _data_->_tmp196_->test_mode;
													if (_data_->_tmp197_) {
...
static gchar* user_list_real_get_lightdm_session (GreeterList* base) {
	...
	if (_tmp4_) {
		...
		while (TRUE) {
			...
			remote_server_copy ((RemoteServer*) _tmp16_, &_tmp17_);
		...
		_tmp26_ = answer;
		_tmp27_ = user_list_is_supported_remote_session (self, _tmp26_);
		if (_tmp27_) {
			result = answer;
			_g_free0 (url);
			return result;
		...
		gchar* _tmp31_ = NULL;
		_tmp29_ = user_list_get_session (self);
		_tmp30_ = _tmp29_;
...
static void user_list_real_show_prompt_cb (GreeterList* base, const gchar* text, LightDMPromptType type) {
	...
	if (_tmp4_) {
		...
		if (g_strcmp0 (_tmp5_, "remote login:") == 0) {
			...
			const gchar* _tmp18_ = NULL;
			_tmp18_ = text;
			if (g_strcmp0 (_tmp18_, "password:") == 0) {
				GtkEntry* field = NULL;
				...
				const gchar* _tmp31_ = NULL;
				_tmp31_ = text;
				if (g_strcmp0 (_tmp31_, "remote host:") == 0) {
					gchar* answer = NULL;
					...
					if (g_strcmp0 (_tmp39_, "domain:") == 0) {
						...
						gchar* answer = NULL;
						gchar* _tmp49_ = NULL;
						UnityGreeter* _tmp50_ = NULL;
						const gchar* _tmp51_ = NULL;
						_tmp40_ = self->priv->current_remote_fields;
						_tmp41_ = g_hash_table_lookup (_tmp40_, "domain");
						_tmp42_ = (GtkWidget*) _tmp41_;
						_tmp43_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp42_, gtk_entry_get_type ()) ? ((GtkEntry*) _tmp42_) : NULL);
						field = _tmp43_;
						_tmp45_ = field;
						if (_tmp45_ != NULL) {
...
static gboolean user_list_add_test_entry (UserList* self) {
	...
	gchar* _tmp7_ = NULL;
	const gchar* _tmp8_ = NULL;
	UserListTestEntry _tmp25_ = {0};
	const gchar* _tmp26_ = NULL;
	UserListTestEntry _tmp27_ = {0};
	const gchar* _tmp28_ = NULL;
	const gchar* _tmp29_ = NULL;
	UserListTestEntry _tmp30_ = {0};
	gboolean _tmp31_ = FALSE;
	UserListTestEntry _tmp32_ = {0};
	gboolean _tmp33_ = FALSE;
	UserListTestEntry _tmp34_ = {0};
	const gchar* _tmp35_ = NULL;
	gint _tmp36_ = 0;
	g_return_val_if_fail (self != NULL, FALSE);
	...
	if (g_strcmp0 (_tmp8_, "*") == 0) {
		...
		background_index = 0;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp9_ = FALSE;
					_tmp11_ = i;
					_tmp12_ = self->priv->n_test_entries;
					if (!(_tmp11_ < _tmp12_)) {
						break;
					}
					_tmp13_ = i;
					_tmp14_ = USER_LIST_test_entries[_tmp13_];
					_tmp15_ = _tmp14_.background;
					if (g_strcmp0 (_tmp15_, "*") == 0) {
						gint _tmp16_ = 0;
						_tmp16_ = background_index;
						background_index = _tmp16_ + 1;
					}
				}
			}
		}
		_tmp17_ = self->priv->test_backgrounds;
		...
		if (_tmp18_ > ((guint) 0)) {
			...
			gchar* _tmp24_ = NULL;
			_tmp19_ = self->priv->test_backgrounds;
			_tmp20_ = background_index;
			_tmp21_ = self->priv->test_backgrounds;
			_tmp22_ = g_list_length (_tmp21_);
			_tmp23_ = g_list_nth_data (_tmp19_, _tmp20_ % _tmp22_);
	...
	_tmp25_ = e;
	_tmp26_ = _tmp25_.username;
	_tmp27_ = e;
	_tmp28_ = _tmp27_.real_name;
	_tmp29_ = background;
	_tmp30_ = e;
	_tmp31_ = _tmp30_.is_active;
	_tmp32_ = e;
	_tmp33_ = _tmp32_.has_messages;
	_tmp34_ = e;
	_tmp35_ = _tmp34_.session;
	user_list_add_user (self, _tmp26_, _tmp28_, _tmp29_, _tmp31_, _tmp33_, _tmp35_);
	_tmp36_ = self->priv->n_test_entries;
	self->priv->n_test_entries = _tmp36_ + 1;
	result = TRUE;
	_g_free0 (background);
	user_list_test_entry_destroy (&e);
	return result;
...
static void user_list_test_respond (UserList* self, const gchar* text) {
	...
	if (_tmp4_ == ((0 != _tmp3_label0) ? _tmp3_label0 : (_tmp3_label0 = g_quark_from_static_string ("*other")))) {
		...
		switch (0) {
			default:
			{
				...
				if (_tmp13_ == NULL) {
					...
					((GreeterList*) self)->test_is_authenticated = _tmp16_;
					greeter_list_authentication_complete_cb ((GreeterList*) self);
				}
				break;
			}
		...
		switch (0) {
			...
			{
				const gchar* _tmp19_ = NULL;
				_tmp19_ = self->priv->test_new_password;
				if (_tmp19_ != NULL) {
					const gchar* _tmp20_ = NULL;
					const gchar* _tmp21_ = NULL;
					_tmp20_ = text;
					_tmp21_ = self->priv->test_new_password;
					((GreeterList*) self)->test_is_authenticated = g_strcmp0 (_tmp20_, _tmp21_) == 0;
					greeter_list_authentication_complete_cb ((GreeterList*) self);
				} else {
					gboolean _tmp22_ = FALSE;
					_tmp22_ = self->priv->test_request_new_password;
					if (_tmp22_) {
						const gchar* _tmp23_ = NULL;
						gchar* _tmp24_ = NULL;
						_tmp23_ = text;
		...
		switch (0) {
			default:
			{
				...
				gboolean _tmp27_ = FALSE;
				_tmp26_ = text;
				((GreeterList*) self)->test_is_authenticated = g_strcmp0 (_tmp26_, "password") == 0;
				_tmp27_ = ((GreeterList*) self)->test_is_authenticated;
				if (_tmp27_) {
		...
		switch (0) {
			default:
			{
				const gchar* _tmp28_ = NULL;
				_tmp28_ = text;
				((GreeterList*) self)->test_is_authenticated = g_strcmp0 (_tmp28_, "password") == 0;
				greeter_list_authentication_complete_cb ((GreeterList*) self);
				break;
			}
		}
...
static GObject * user_list_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	if (!_tmp12_) {
		UnityGreeter* _tmp13_ = NULL;
		gboolean _tmp14_ = FALSE;
		_tmp13_ = unity_greeter_singleton;
		_tmp14_ = unity_greeter_show_remote_login_hint (_tmp13_);
		_tmp10_ = _tmp14_;
	} else {
		_tmp10_ = FALSE;
	}
...
static void user_list_class_init (UserListClass * klass) {
	...
	((GreeterListClass *) klass)->insert_entry = user_list_real_insert_entry;
	((GreeterListClass *) klass)->setup_prompt_box = user_list_real_setup_prompt_box;
	((GreeterListClass *) klass)->start_authentication = user_list_real_start_authentication;
	((GreeterListClass *) klass)->focus_prompt = user_list_real_focus_prompt;
	((GreeterListClass *) klass)->show_authenticated = user_list_real_show_authenticated;
	((GreeterListClass *) klass)->add_manual_entry = user_list_real_add_manual_entry;
	((GreeterListClass *) klass)->get_lightdm_session = user_list_real_get_lightdm_session;
	((GreeterListClass *) klass)->show_prompt_cb = user_list_real_show_prompt_cb;
	((GreeterListClass *) klass)->test_start_authentication = user_list_real_test_start_authentication;
