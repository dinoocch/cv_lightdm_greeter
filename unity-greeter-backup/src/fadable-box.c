/* fadable-box.c generated by valac 0.26.2, the Vala compiler
...
static void __fadable_box___lambda29__fade_tracker_done (FadeTracker* _sender, gpointer self);
...
static void fadable_box_real_draw_full_alpha (FadableBox* self, cairo_t* c) {
	...
	_tmp0_ = c;
	GTK_WIDGET_CLASS (fadable_box_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_event_box_get_type (), GtkEventBox), _tmp0_);
}
...
static void fadable_box_class_init (FadableBoxClass * klass) {
	...
	((FadableBoxClass *) klass)->draw_full_alpha = fadable_box_real_draw_full_alpha;
	((GtkWidgetClass *) klass)->draw = fadable_box_real_draw;
