/* shutdown-dialog.c generated by valac 0.26.2, the Vala compiler
...
static void _____lambda21__gtk_button_clicked (GtkButton* _sender, gpointer self);
...
static void _____lambda24__gtk_widget_show (GtkWidget* _sender, gpointer self);
...
static gdouble __lambda26_ (ShutdownDialog* self, gdouble x);
static gdouble ___lambda26__animate_timer_easing_func (gdouble x, gpointer self);
...
static void ___lambda27__animate_timer_animate (AnimateTimer* _sender, gdouble progress, gpointer self);
...
static gdouble __lambda17_ (Block6Data* _data6_, gdouble x);
static gdouble ___lambda17__animate_timer_easing_func (gdouble x, gpointer self);
static void __lambda18_ (ShutdownDialog* self, gdouble p);
void animate_timer_stop (AnimateTimer* self);
static void ___lambda18__animate_timer_animate (AnimateTimer* _sender, gdouble progress, gpointer self);
...
ShutdownDialog* shutdown_dialog_construct (GType object_type, ShutdownDialogType type, Background* bg) {
	...
	g_signal_connect_object ((GtkWidget*) _tmp10_, "button-press-event", (GCallback) ___lambda16__gtk_widget_button_press_event, self, 0);
	...
	g_signal_connect_object ((GtkWidget*) _tmp38_, "button-press-event", (GCallback) ___lambda19__gtk_widget_button_press_event, self, 0);
...
"w will also close these other sessions.");
	...
	if (_tmp92_ == SHUTDOWN_DIALOG_TYPE_SHUTDOWN) {
		...
		if (_tmp93_) {
			...
			button = _tmp100_;
			_tmp101_ = button;
			g_signal_connect_object ((GtkButton*) _tmp101_, "clicked", (GCallback) _____lambda20__gtk_button_clicked, self, 0);
		...
		if (_tmp102_) {
			...
			button = _tmp109_;
			_tmp110_ = button;
			g_signal_connect_object ((GtkButton*) _tmp110_, "clicked", (GCallback) _____lambda21__gtk_button_clicked, self, 0);
			_g_object_unref0 (button);
		}
	}
	...
	if (_tmp111_) {
		...
		button = _tmp118_;
		_tmp119_ = button;
		g_signal_connect_object ((GtkButton*) _tmp119_, "clicked", (GCallback) ____lambda22__gtk_button_clicked, self, 0);
		_g_object_unref0 (button);
	}
	...
	if (_tmp120_) {
		...
		g_signal_connect_object ((GtkButton*) _tmp128_, "clicked", (GCallback) ____lambda23__gtk_button_clicked, self, 0);
		_tmp129_ = type;
	...
	g_signal_connect_object ((GtkButton*) _tmp138_, "clicked", (GCallback) ___lambda25__gtk_button_clicked, self, 0);
	...
	_tmp141_ = animate_timer_new (___lambda26__animate_timer_easing_func, self, ANIMATE_TIMER_INSTANT);
	_g_object_unref0 (self->priv->animation);
	self->priv->animation = _tmp141_;
	_tmp142_ = self->priv->animation;
	g_signal_connect_object (_tmp142_, "animate", (GCallback) ___lambda27__animate_timer_animate, self, 0);
...
void shutdown_dialog_set_active_monitor (ShutdownDialog* self, Monitor* m) {
	...
	_tmp6_ = m;
	_tmp7_ = _monitor_ref0 (_tmp6_);
	_monitor_unref0 (self->priv->monitor);
	self->priv->monitor = _tmp7_;
	shutdown_dialog_rebuild_background (self);
	_tmp8_ = self->priv->monitor;
	_tmp9_ = _tmp8_->width;
	_tmp10_ = self->priv->monitor;
	_tmp11_ = _tmp10_->height;
	gtk_widget_set_size_request ((GtkWidget*) self, _tmp9_, _tmp11_);
}
...
static gboolean shutdown_dialog_real_draw (GtkWidget* base, cairo_t* c) {
	...
	cairo_matrix_t _tmp101_ = {0};
	cairo_t* _tmp102_ = NULL;
	cairo_pattern_t* _tmp103_ = NULL;
	...
	cairo_matrix_t _tmp134_ = {0};
	cairo_t* _tmp135_ = NULL;
	cairo_pattern_t* _tmp136_ = NULL;
	cairo_t* _tmp137_ = NULL;
	gint _tmp138_ = 0;
	cairo_t* _tmp139_ = NULL;
	gint _tmp140_ = 0;
	cairo_pattern_t* _tmp141_ = NULL;
	cairo_matrix_t _tmp142_ = {0};
	cairo_t* _tmp143_ = NULL;
	cairo_pattern_t* _tmp144_ = NULL;
	...
	if (_tmp32_) {
		...
		_tmp37_ = width;
		_tmp38_ = height;
		_tmp39_ = cairo_image_surface_create (CAIRO_FORMAT_ARGB32, _tmp37_, _tmp38_);
		_cairo_surface_destroy0 (self->priv->bg_surface);
		self->priv->bg_surface = _tmp39_;
		_tmp40_ = self->priv->bg_surface;
		_tmp41_ = cairo_create (_tmp40_);
		bg_cr = _tmp41_;
		_tmp42_ = bg_cr;
		_tmp43_ = c;
		_tmp44_ = cairo_get_target (_tmp43_);
		_tmp45_ = x;
		_tmp46_ = self->priv->monitor;
		_tmp47_ = _tmp46_->x;
		_tmp48_ = y;
		_tmp49_ = self->priv->monitor;
		_tmp50_ = _tmp49_->y;
		cairo_set_source_surface (_tmp42_, _tmp44_, (gdouble) ((-_tmp45_) - _tmp47_), (gdouble) ((-_tmp48_) - _tmp50_));
		_tmp51_ = bg_cr;
		_tmp52_ = width;
		_tmp53_ = height;
		cairo_rectangle (_tmp51_, (gdouble) 0, (gdouble) 0, (gdouble) _tmp52_, (gdouble) _tmp53_);
		_tmp54_ = bg_cr;
		cairo_fill (_tmp54_);
		_tmp55_ = self->priv->bg_surface;
		cairo_utils_exponential_blur_surface (_tmp55_, SHUTDOWN_DIALOG_BLUR_RADIUS);
	...
	_tmp58_ = x;
	_tmp59_ = y;
	cairo_translate (_tmp57_, (gdouble) _tmp58_, (gdouble) _tmp59_);
	_tmp60_ = c;
	_tmp61_ = width;
	_tmp62_ = height;
	cairo_utils_rounded_rectangle (_tmp60_, (gdouble) 0, (gdouble) 0, (gdouble) _tmp61_, (gdouble) _tmp62_, (gdouble) 4);
	_tmp63_ = c;
	_tmp64_ = self->priv->bg_surface;
	cairo_set_source_surface (_tmp63_, _tmp64_, (gdouble) 0, (gdouble) 0);
	_tmp65_ = c;
	cairo_fill_preserve (_tmp65_);
	_tmp66_ = c;
	_tmp67_ = self->priv->avg_color;
	_tmp68_ = _tmp67_.red;
	_tmp69_ = self->priv->avg_color;
	_tmp70_ = _tmp69_.green;
	_tmp71_ = self->priv->avg_color;
	_tmp72_ = _tmp71_.blue;
	_tmp73_ = self->priv->avg_color;
	_tmp74_ = _tmp73_.alpha;
	cairo_set_source_rgba (_tmp66_, _tmp68_, _tmp70_, _tmp72_, _tmp74_);
	_tmp75_ = c;
	cairo_fill (_tmp75_);
	_tmp76_ = c;
	cairo_restore (_tmp76_);
	_tmp77_ = x;
	x = _tmp77_ - SHUTDOWN_DIALOG_BORDER_EXTERNAL_SIZE;
	_tmp78_ = y;
	y = _tmp78_ - SHUTDOWN_DIALOG_BORDER_EXTERNAL_SIZE;
	_tmp79_ = width;
	width = _tmp79_ + (SHUTDOWN_DIALOG_BORDER_EXTERNAL_SIZE * 2);
	_tmp80_ = height;
	height = _tmp80_ + (SHUTDOWN_DIALOG_BORDER_EXTERNAL_SIZE * 2);
	_tmp81_ = c;
	cairo_save (_tmp81_);
	_tmp82_ = c;
	_tmp83_ = x;
	_tmp84_ = y;
	cairo_translate (_tmp82_, (gdouble) _tmp83_, (gdouble) _tmp84_);
	cairo_matrix_init_identity (&m);
	_tmp85_ = self->priv->corner_pattern;
	_tmp86_ = m;
	cairo_pattern_set_matrix (_tmp85_, &_tmp86_);
	_tmp87_ = c;
	_tmp88_ = self->priv->corner_pattern;
	cairo_set_source (_tmp87_, _tmp88_);
	_tmp89_ = c;
	cairo_rectangle (_tmp89_, (gdouble) 0, (gdouble) 0, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp90_ = c;
	cairo_fill (_tmp90_);
	cairo_matrix_init_identity (&m);
	_tmp91_ = width;
	cairo_matrix_translate (&m, (gdouble) _tmp91_, (gdouble) 0);
	cairo_matrix_scale (&m, (gdouble) (-1), (gdouble) 1);
	_tmp92_ = self->priv->corner_pattern;
	_tmp93_ = m;
	cairo_pattern_set_matrix (_tmp92_, &_tmp93_);
	_tmp94_ = c;
	_tmp95_ = self->priv->corner_pattern;
	cairo_set_source (_tmp94_, _tmp95_);
	_tmp96_ = c;
	_tmp97_ = width;
	cairo_rectangle (_tmp96_, (gdouble) (_tmp97_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) 0, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp98_ = c;
	cairo_fill (_tmp98_);
	cairo_matrix_init_identity (&m);
	_tmp99_ = height;
	cairo_matrix_translate (&m, (gdouble) 0, (gdouble) _tmp99_);
	cairo_matrix_scale (&m, (gdouble) 1, (gdouble) (-1));
	_tmp100_ = self->priv->corner_pattern;
	_tmp101_ = m;
	cairo_pattern_set_matrix (_tmp100_, &_tmp101_);
	_tmp102_ = c;
	_tmp103_ = self->priv->corner_pattern;
	cairo_set_source (_tmp102_, _tmp103_);
	_tmp104_ = c;
	_tmp105_ = height;
	cairo_rectangle (_tmp104_, (gdouble) 0, (gdouble) (_tmp105_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp106_ = c;
	cairo_fill (_tmp106_);
	cairo_matrix_init_identity (&m);
	_tmp107_ = width;
	_tmp108_ = height;
	cairo_matrix_translate (&m, (gdouble) _tmp107_, (gdouble) _tmp108_);
	cairo_matrix_scale (&m, (gdouble) (-1), (gdouble) (-1));
	_tmp109_ = self->priv->corner_pattern;
	_tmp110_ = m;
	cairo_pattern_set_matrix (_tmp109_, &_tmp110_);
	_tmp111_ = c;
	_tmp112_ = self->priv->corner_pattern;
	cairo_set_source (_tmp111_, _tmp112_);
	_tmp113_ = c;
	_tmp114_ = width;
	_tmp115_ = height;
	cairo_rectangle (_tmp113_, (gdouble) (_tmp114_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) (_tmp115_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp116_ = c;
	cairo_fill (_tmp116_);
	cairo_matrix_init_identity (&m);
	_tmp117_ = self->priv->left_pattern;
	_tmp118_ = m;
	cairo_pattern_set_matrix (_tmp117_, &_tmp118_);
	_tmp119_ = c;
	_tmp120_ = self->priv->left_pattern;
	cairo_set_source (_tmp119_, _tmp120_);
	_tmp121_ = c;
	_tmp122_ = height;
	cairo_rectangle (_tmp121_, (gdouble) 0, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) (_tmp122_ - (SHUTDOWN_DIALOG_BORDER_SIZE * 2)));
	_tmp123_ = c;
	cairo_fill (_tmp123_);
	cairo_matrix_init_identity (&m);
	_tmp124_ = width;
	cairo_matrix_translate (&m, (gdouble) _tmp124_, (gdouble) 0);
	cairo_matrix_scale (&m, (gdouble) (-1), (gdouble) 1);
	_tmp125_ = self->priv->left_pattern;
	_tmp126_ = m;
	cairo_pattern_set_matrix (_tmp125_, &_tmp126_);
	_tmp127_ = c;
	_tmp128_ = self->priv->left_pattern;
	cairo_set_source (_tmp127_, _tmp128_);
	_tmp129_ = c;
	_tmp130_ = width;
	_tmp131_ = height;
	cairo_rectangle (_tmp129_, (gdouble) (_tmp130_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) (_tmp131_ - (SHUTDOWN_DIALOG_BORDER_SIZE * 2)));
	_tmp132_ = c;
	cairo_fill (_tmp132_);
	cairo_matrix_init_identity (&m);
	_tmp133_ = self->priv->top_pattern;
	_tmp134_ = m;
	cairo_pattern_set_matrix (_tmp133_, &_tmp134_);
	_tmp135_ = c;
	_tmp136_ = self->priv->top_pattern;
	cairo_set_source (_tmp135_, _tmp136_);
	_tmp137_ = c;
	_tmp138_ = width;
	cairo_rectangle (_tmp137_, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) 0, (gdouble) (_tmp138_ - (SHUTDOWN_DIALOG_BORDER_SIZE * 2)), (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp139_ = c;
	cairo_fill (_tmp139_);
	cairo_matrix_init_identity (&m);
	_tmp140_ = height;
	cairo_matrix_translate (&m, (gdouble) 0, (gdouble) _tmp140_);
	cairo_matrix_scale (&m, (gdouble) 1, (gdouble) (-1));
	_tmp141_ = self->priv->top_pattern;
	_tmp142_ = m;
	cairo_pattern_set_matrix (_tmp141_, &_tmp142_);
	_tmp143_ = c;
	_tmp144_ = self->priv->top_pattern;
	cairo_set_source (_tmp143_, _tmp144_);
	_tmp145_ = c;
	_tmp146_ = height;
	_tmp147_ = width;
	cairo_rectangle (_tmp145_, (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE, (gdouble) (_tmp146_ - SHUTDOWN_DIALOG_BORDER_SIZE), (gdouble) (_tmp147_ - (SHUTDOWN_DIALOG_BORDER_SIZE * 2)), (gdouble) SHUTDOWN_DIALOG_BORDER_SIZE);
	_tmp148_ = c;
	cairo_fill (_tmp148_);
	_tmp149_ = c;
	cairo_restore (_tmp149_);
	_tmp150_ = c;
	_tmp151_ = GTK_WIDGET_CLASS (shutdown_dialog_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_fixed_get_type (), GtkFixed), _tmp150_);
	ret = _tmp151_;
	_tmp152_ = self->priv->animation;
	_tmp153_ = animate_timer_get_is_running (_tmp152_);
	_tmp154_ = _tmp153_;
	if (_tmp154_) {
		...
		_tmp155_ = c;
		cairo_pop_group_to_source (_tmp155_);
		_tmp157_ = self->priv->closing;
		if (_tmp157_) {
			AnimateTimer* _tmp158_ = NULL;
			gdouble _tmp159_ = 0.0;
			gdouble _tmp160_ = 0.0;
			_tmp158_ = self->priv->animation;
			_tmp159_ = animate_timer_get_progress (_tmp158_);
			_tmp160_ = _tmp159_;
			_tmp156_ = 1.0f - _tmp160_;
		} else {
			AnimateTimer* _tmp161_ = NULL;
			gdouble _tmp162_ = 0.0;
			gdouble _tmp163_ = 0.0;
			_tmp161_ = self->priv->animation;
			_tmp162_ = animate_timer_get_progress (_tmp161_);
			_tmp163_ = _tmp162_;
			_tmp156_ = _tmp163_;
		}
		_tmp164_ = c;
		cairo_paint_with_alpha (_tmp164_, _tmp156_);
	}
	result = ret;
	return result;
}
...
static void shutdown_dialog_class_init (ShutdownDialogClass * klass) {
	...
	((GtkWidgetClass *) klass)->size_allocate = shutdown_dialog_real_size_allocate;
	((GtkWidgetClass *) klass)->draw = shutdown_dialog_real_draw;
...
static gboolean dialog_button_real_enter_notify_event (GtkWidget* base, GdkEventCrossing* event) {
	...
	_tmp0_ = event;
	_tmp1_ = GTK_WIDGET_CLASS (dialog_button_parent_class)->enter_notify_event ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp0_);
	result = _tmp1_;
	return result;
}
...
static gboolean dialog_button_real_leave_notify_event (GtkWidget* base, GdkEventCrossing* event) {
	...
	_tmp1_ = event;
	_tmp2_ = GTK_WIDGET_CLASS (dialog_button_parent_class)->leave_notify_event ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp1_);
	result = _tmp2_;
	return result;
}
...
static void dialog_button_real_state_flags_changed (GtkWidget* base, GtkStateFlags previous_state) {
	...
	if (_tmp2_) {
		...
		_tmp6_ = new_flags;
		_tmp1_ = (_tmp6_ & GTK_STATE_FLAG_FOCUSED) != 0;
	}
	if (_tmp1_) {
		gboolean _tmp7_ = FALSE;
		GtkStateFlags _tmp8_ = 0;
		_tmp8_ = new_flags;
		if ((_tmp8_ & GTK_STATE_FLAG_ACTIVE) != 0) {
			const gchar* _tmp9_ = NULL;
			_tmp9_ = self->priv->active_filename;
			_tmp7_ = _tmp9_ != NULL;
		} else {
			_tmp7_ = FALSE;
		}
		if (_tmp7_) {
			...
			_tmp12_ = self->priv->i;
			_tmp13_ = self->priv->focused_filename;
		...
		_tmp14_ = self->priv->i;
		_tmp15_ = self->priv->inactive_filename;
		gtk_image_set_from_file (_tmp14_, _tmp15_);
	}
	_tmp16_ = self->priv->l;
	if (_tmp16_ != NULL) {
		GtkLabel* _tmp17_ = NULL;
		...
		_tmp17_ = self->priv->l;
		_tmp18_ = new_flags;
		gtk_widget_set_state_flags ((GtkWidget*) _tmp17_, _tmp18_, TRUE);
	}
	_tmp19_ = previous_state;
	GTK_WIDGET_CLASS (dialog_button_parent_class)->state_flags_changed ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp19_);
}
...
static void dialog_button_class_init (DialogButtonClass * klass) {
	...
	((GtkWidgetClass *) klass)->enter_notify_event = dialog_button_real_enter_notify_event;
	((GtkWidgetClass *) klass)->leave_notify_event = dialog_button_real_leave_notify_event;
	((GtkWidgetClass *) klass)->draw = dialog_button_real_draw;
	((GtkWidgetClass *) klass)->state_flags_changed = dialog_button_real_state_flags_changed;
