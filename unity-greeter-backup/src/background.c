/* background.c generated by valac 0.26.2, the Vala compiler
...
static void ____lambda5__background_loader_loaded (BackgroundLoader* _sender, gpointer self);
...
gboolean background_loader_load (BackgroundLoader* self) {
	...
	text = _tmp8_;
	{
		...
		i = 1;
		{
			...
			while (TRUE) {
				...
				_tmp13_ = text;
				_tmp14_ = self->widths;
				_tmp14__length1 = self->widths_length1;
				_tmp15_ = i;
				_tmp16_ = _tmp14_[_tmp15_];
				_tmp17_ = self->heights;
				_tmp17__length1 = self->heights_length1;
				_tmp18_ = i;
				_tmp19_ = _tmp17_[_tmp18_];
				_tmp20_ = g_strdup_printf (",%dx%d", _tmp16_, _tmp19_);
				_tmp21_ = _tmp20_;
	...
	_tmp23_ = text;
	g_debug ("background.vala:68: %s", _tmp23_);
	memset (&color, 0, sizeof (GdkRGBA));
	_tmp24_ = self->priv->_filename;
	_tmp25_ = gdk_rgba_parse (&color, _tmp24_);
	if (_tmp25_) {
		...
		_tmp32_ = color;
		_tmp33_ = _tmp32_.alpha;
		_tmp34_ = cairo_pattern_create_rgba (_tmp27_, _tmp29_, _tmp31_, _tmp33_);
		pattern = _tmp34_;
		{
			gint i = 0;
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp37_ = i;
					_tmp38_ = self->widths;
					_tmp38__length1 = self->widths_length1;
					if (!(_tmp37_ < _tmp38__length1)) {
						break;
					}
					_tmp39_ = self->patterns;
					_tmp39__length1 = self->patterns_length1;
					_tmp40_ = i;
					_tmp41_ = pattern;
					_tmp42_ = _cairo_pattern_reference0 (_tmp41_);
					_cairo_pattern_destroy0 (_tmp39_[_tmp40_]);
		...
		_tmp44_ = color;
		self->average_color = _tmp44_;
		self->priv->finished = TRUE;
		_tmp45_ = self->priv->_filename;
		g_debug ("background.vala:79: Render of background %s complete", _tmp45_);
		result = TRUE;
		...
		{
			GThread* _tmp46_ = NULL;
			GThread* _tmp47_ = NULL;
			GThread* _tmp48_ = NULL;
			g_object_ref ((GObject*) self);
			_tmp47_ = g_thread_try_new ("background-loader", _background_loader_load_and_scale_gthread_func, g_object_ref (self), &_inner_error_);
			_tmp46_ = _tmp47_;
	...
	g_return_val_if_fail (self != NULL, NULL);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp5_ = self->widths;
				_tmp5__length1 = self->widths_length1;
				_tmp6_ = i;
				...
				if (_tmp4_) {
					...
					_tmp13_ = self->patterns;
					_tmp13__length1 = self->patterns_length1;
					_tmp14_ = i;
					_tmp15_ = _tmp13_[_tmp14_];
					_tmp16_ = _cairo_pattern_reference0 (_tmp15_);
					result = _tmp16_;
					return result;
				}
			}
...
static void* background_loader_load_and_scale (BackgroundLoader* self) {
		...
		}
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp6_ = self->priv->images;
					_tmp6__length1 = self->priv->images_length1;
					_tmp7_ = i;
					_tmp8_ = image;
					_tmp9_ = self->widths;
					_tmp9__length1 = self->widths_length1;
					_tmp10_ = i;
					_tmp11_ = _tmp9_[_tmp10_];
					_tmp12_ = self->heights;
					_tmp12__length1 = self->heights_length1;
					_tmp13_ = i;
					_tmp14_ = _tmp12_[_tmp13_];
					_tmp15_ = background_loader_scale (self, _tmp8_, _tmp11_, _tmp14_);
					_g_object_unref0 (_tmp6_[_tmp7_]);
					_tmp6_[_tmp7_] = _tmp15_;
					_tmp16_ = _tmp6_[_tmp7_];
				}
			}
		}
	...
	__catch1_g_error:
	{
		...
		g_debug ("background.vala:159: Error loading background: %s", _tmp18_);
		_g_error_free0 (e);
	}
	__finally1:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp19_ = gdk_threads_add_idle (_background_loader_ready_cb_gsource_func, self);
	self->priv->ready_id = _tmp19_;
	result = NULL;
	return result;
}
...
static gboolean background_loader_is_color_different (BackgroundLoader* self, GdkRGBA* color_a, GdkRGBA* color_b) {
	...
	if (_tmp13_) {
		...
		_tmp22_ = fabs (_tmp21_);
		_tmp12_ = _tmp22_ > 0.15;
	}
	if (_tmp12_) {
		result = TRUE;
		return result;
...
static void background_loader_get_quad_average (BackgroundLoader* self, gint x, gint y, gint width, gint height, gint level_of_recursion, guint8* pixels, int pixels_length1, gint rowstride, gint channels, GdkRGBA* result) {
	...
	if (_tmp36_ < BACKGROUND_LOADER_QUAD_MAX_LEVEL_OF_RECURSION) {
		...
		if (_tmp37_) {
			...
			_tmp44_ = width;
			_tmp45_ = height;
			_tmp46_ = level_of_recursion;
			_tmp47_ = pixels;
			_tmp47__length1 = pixels_length1;
			_tmp48_ = rowstride;
			_tmp49_ = channels;
			background_loader_get_quad_average (self, _tmp42_, _tmp43_, _tmp44_ / 2, _tmp45_ / 2, _tmp46_ + 1, _tmp47_, _tmp47__length1, _tmp48_, _tmp49_, &_tmp50_);
			corner1 = _tmp50_;
		}
		_tmp52_ = level_of_recursion;
		if (_tmp52_ < BACKGROUND_LOADER_QUAD_MIN_LEVEL_OF_RECURSION) {
			_tmp51_ = TRUE;
		} else {
			GdkRGBA _tmp53_ = {0};
			GdkRGBA _tmp54_ = {0};
			...
			_tmp53_ = corner2;
			_tmp54_ = centre;
			_tmp55_ = background_loader_is_color_different (self, &_tmp53_, &_tmp54_);
			_tmp51_ = _tmp55_;
		}
		if (_tmp51_) {
			gint _tmp56_ = 0;
			...
			_tmp59_ = width;
			_tmp60_ = height;
			_tmp61_ = level_of_recursion;
			_tmp62_ = pixels;
			_tmp62__length1 = pixels_length1;
			_tmp63_ = rowstride;
			_tmp64_ = channels;
			background_loader_get_quad_average (self, _tmp56_ + (_tmp57_ / 2), _tmp58_, _tmp59_ / 2, _tmp60_ / 2, _tmp61_ + 1, _tmp62_, _tmp62__length1, _tmp63_, _tmp64_, &_tmp65_);
			corner2 = _tmp65_;
		}
		_tmp67_ = level_of_recursion;
		if (_tmp67_ < BACKGROUND_LOADER_QUAD_MIN_LEVEL_OF_RECURSION) {
			_tmp66_ = TRUE;
		} else {
			GdkRGBA _tmp68_ = {0};
			GdkRGBA _tmp69_ = {0};
			...
			_tmp68_ = corner3;
			_tmp69_ = centre;
			_tmp70_ = background_loader_is_color_different (self, &_tmp68_, &_tmp69_);
			_tmp66_ = _tmp70_;
		}
		if (_tmp66_) {
			gint _tmp71_ = 0;
			...
			_tmp74_ = width;
			_tmp75_ = height;
			_tmp76_ = level_of_recursion;
			_tmp77_ = pixels;
			_tmp77__length1 = pixels_length1;
			_tmp78_ = rowstride;
			_tmp79_ = channels;
			background_loader_get_quad_average (self, _tmp71_, _tmp72_ + (_tmp73_ / 2), _tmp74_ / 2, _tmp75_ / 2, _tmp76_ + 1, _tmp77_, _tmp77__length1, _tmp78_, _tmp79_, &_tmp80_);
			corner3 = _tmp80_;
		}
		_tmp82_ = level_of_recursion;
		if (_tmp82_ < BACKGROUND_LOADER_QUAD_MIN_LEVEL_OF_RECURSION) {
			_tmp81_ = TRUE;
		} else {
			GdkRGBA _tmp83_ = {0};
			GdkRGBA _tmp84_ = {0};
			...
			_tmp83_ = corner4;
			_tmp84_ = centre;
			_tmp85_ = background_loader_is_color_different (self, &_tmp83_, &_tmp84_);
			_tmp81_ = _tmp85_;
		}
		if (_tmp81_) {
			gint _tmp86_ = 0;
			...
			_tmp90_ = width;
			_tmp91_ = height;
			_tmp92_ = level_of_recursion;
			_tmp93_ = pixels;
			_tmp93__length1 = pixels_length1;
			_tmp94_ = rowstride;
			_tmp95_ = channels;
			background_loader_get_quad_average (self, _tmp86_ + (_tmp87_ / 2), _tmp88_ + (_tmp89_ / 2), _tmp90_ / 2, _tmp91_ / 2, _tmp92_ + 1, _tmp93_, _tmp93__length1, _tmp94_, _tmp95_, &_tmp96_);
			corner4 = _tmp96_;
		}
	}
	_tmp97_ = corner1;
	...
	average.red = (((((_tmp98_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NW) + (_tmp100_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SW)) + (_tmp102_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_CENTER)) + (_tmp104_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NE)) + (_tmp106_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SE)) / BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_TOTAL;
	_tmp107_ = corner1;
	_tmp108_ = _tmp107_.green;
	_tmp109_ = corner3;
	...
	average.green = (((((_tmp108_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NW) + (_tmp110_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SW)) + (_tmp112_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_CENTER)) + (_tmp114_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NE)) + (_tmp116_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SE)) / BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_TOTAL;
	_tmp117_ = corner1;
	_tmp118_ = _tmp117_.blue;
	_tmp119_ = corner3;
	_tmp120_ = _tmp119_.blue;
	_tmp121_ = centre;
	...
	average.blue = (((((_tmp118_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NW) + (_tmp120_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SW)) + (_tmp122_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_CENTER)) + (_tmp124_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_NE)) + (_tmp126_ * BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_SE)) / BACKGROUND_LOADER_QUAD_CORNER_WEIGHT_TOTAL;
...
static void background_real_size_allocate (GtkWidget* base, GtkAllocation* allocation) {
	...
	resized = _tmp0_;
	_tmp7_ = *allocation;
	GTK_WIDGET_CLASS (background_parent_class)->size_allocate ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_fixed_get_type (), GtkFixed), &_tmp7_);
	_tmp8_ = resized;
	if (_tmp8_) {
		...
		_tmp10_ = background_load_background (self, NULL);
		_tmp11_ = _tmp10_;
...
static gboolean background_real_draw (GtkWidget* base, cairo_t* c) {
	...
	_tmp4_ = c;
	_tmp5_ = GTK_WIDGET_CLASS (background_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_fixed_get_type (), GtkFixed), _tmp4_);
	result = _tmp5_;
	return result;
}
...
void background_draw_full (Background* self, cairo_t* c, BackgroundDrawFlags flags) {
	...
	if (_tmp1_) {
		...
		if (_tmp10_ != NULL) {
			...
			gchar* _tmp15_ = NULL;
			BackgroundLoader* _tmp16_ = NULL;
			BackgroundLoader* _tmp17_ = NULL;
			_tmp11_ = self->priv->loaders;
			_tmp12_ = self->priv->current;
			_tmp13_ = background_loader_get_filename (_tmp12_);
			_tmp14_ = _tmp13_;
			_tmp15_ = g_strdup (_tmp14_);
			_tmp16_ = new_background;
			_tmp17_ = _g_object_ref0 (_tmp16_);
			g_hash_table_insert (_tmp11_, _tmp15_, _tmp17_);
		}
		_tmp18_ = self->priv->old;
	...
	if (_tmp24_) {
		...
		animate_timer_reset (_tmp33_, -1);
	}
	_tmp34_ = c;
	cairo_set_source_rgba (_tmp34_, 0.0, 0.0, 0.0, 0.0);
	old_painted = FALSE;
	_tmp37_ = self->priv->old;
	if (_tmp37_ != NULL) {
		BackgroundLoader* _tmp38_ = NULL;
		gboolean _tmp39_ = FALSE;
		_tmp38_ = self->priv->old;
		_tmp39_ = background_loader_load (_tmp38_);
		_tmp36_ = _tmp39_;
	} else {
		_tmp36_ = FALSE;
	}
	...
	if (_tmp35_) {
		...
		_tmp44_ = c;
		_tmp45_ = self->priv->old;
		background_draw_background (self, _tmp44_, _tmp45_, 1.0);
		old_painted = TRUE;
	}
	...
	if (_tmp46_) {
		...
		background_draw_background (self, _tmp53_, _tmp54_, _tmp50_);
	}
	_tmp55_ = c;
	cairo_restore (_tmp55_);
	_tmp56_ = flags;
	if ((_tmp56_ & BACKGROUND_DRAW_FLAGS_GRID) != 0) {
		cairo_t* _tmp57_ = NULL;
		_tmp57_ = c;
		background_overlay_grid (self, _tmp57_);
	}
}
		...
		for (monitor_it = monitor_collection; monitor_it != NULL; monitor_it = monitor_it->next) {
			...
			monitor = _tmp1_;
			{
				...
				if (_tmp37_) {
					...
					gint _tmp47_ = 0;
					Monitor* _tmp48_ = NULL;
					gint _tmp49_ = 0;
					gint _tmp50_ = 0;
					gint y = 0;
					Monitor* _tmp51_ = NULL;
					gint _tmp52_ = 0;
					Monitor* _tmp53_ = NULL;
					gint _tmp54_ = 0;
					gint _tmp55_ = 0;
					gint _tmp56_ = 0;
					gint _tmp57_ = 0;
					cairo_pattern_t* _tmp58_ = NULL;
					cairo_matrix_t _tmp59_ = {0};
					cairo_t* _tmp60_ = NULL;
					cairo_pattern_t* _tmp61_ = NULL;
					...
					_tmp41_ = self->priv->background_logo_width;
					width = _tmp41_;
					_tmp42_ = self->priv->background_logo_height;
					height = _tmp42_;
					_tmp43_ = c;
					cairo_save (_tmp43_);
					_tmp44_ = self->priv->background_logo_surface;
					...
					_tmp50_ = width;
					x = _tmp47_ + ((_tmp49_ - _tmp50_) / 2);
					_tmp51_ = monitor;
					_tmp52_ = _tmp51_->y;
					_tmp53_ = monitor;
					_tmp54_ = _tmp53_->height;
					_tmp55_ = height;
					y = _tmp52_ + ((_tmp54_ - _tmp55_) / 2);
					_tmp56_ = x;
					_tmp57_ = y;
					cairo_matrix_translate (&matrix, (gdouble) (-_tmp56_), (gdouble) (-_tmp57_));
					_tmp58_ = pattern;
					_tmp59_ = matrix;
					...
					_tmp65_ = width;
					_tmp66_ = height;
					cairo_rectangle (_tmp62_, (gdouble) _tmp63_, (gdouble) _tmp64_, (gdouble) _tmp65_, (gdouble) _tmp66_);
					_tmp67_ = c;
					cairo_clip (_tmp67_);
					_tmp68_ = c;
					_tmp69_ = alpha;
					cairo_paint_with_alpha (_tmp68_, _tmp69_);
					_tmp70_ = c;
...
static BackgroundLoader* background_load_background (Background* self, const gchar* filename) {
	...
	if (_tmp6_ == NULL) {
		...
		_tmp40_ = b;
		g_signal_connect_object (_tmp40_, "loaded", (GCallback) ____lambda5__background_loader_loaded, self, 0);
		_tmp41_ = b;
...
static void background_publish_average_color (Background* self) {
	...
	if (!_tmp1_) {
		...
		_tmp2_ = self->priv->current;
		_tmp3_ = gdk_rgba_to_string (&_tmp2_->average_color);
		rgba = _tmp3_;
		_tmp4_ = gtk_widget_get_screen ((GtkWidget*) self);
		_tmp5_ = gdk_screen_get_root_window (_tmp4_);
		_tmp6_ = _g_object_ref0 (_tmp5_);
		root = _tmp6_;
		_tmp7_ = root;
		_tmp8_ = gdk_atom_intern_static_string ("_GNOME_BACKGROUND_REPRESENTATIVE_COLORS");
		_tmp9_ = gdk_atom_intern_static_string ("STRING");
		_tmp10_ = rgba;
		...
		gdk_property_change (_tmp7_, _tmp8_, _tmp9_, 8, GDK_PROP_MODE_REPLACE, (const guchar*) _tmp12_, _tmp15__length1);
...
static void background_class_init (BackgroundClass * klass) {
	...
	((GtkWidgetClass *) klass)->size_allocate = background_real_size_allocate;
	((GtkWidgetClass *) klass)->draw = background_real_draw;
