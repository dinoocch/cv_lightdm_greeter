/* remote-login-service.c generated by valac 0.26.2, the Vala compiler
...
static void _dbus_remote_login_service_get_servers (RemoteLoginService* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
static void _dbus_remote_login_service_get_servers_ready (GObject * source_object, GAsyncResult * _res_, gpointer _user_data_);
static void _dbus_remote_login_service_get_servers_for_login (RemoteLoginService* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_remote_login_service_get_cached_domains_for_server (RemoteLoginService* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_remote_login_service_set_last_used_server (RemoteLoginService* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
