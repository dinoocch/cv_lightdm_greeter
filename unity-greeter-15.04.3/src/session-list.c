/* session-list.c generated by valac 0.26.2, the Vala compiler
...
static void __lambda46_ (SessionList* self, gchar** responses, int responses_length1);
static void ___lambda46__prompt_box_respond (PromptBox* _sender, gchar** response, int response_length1, gpointer self);
...
static gchar* session_list_get_badge_name (const gchar* session) {
	...
	} else if (((((_tmp3_ == ((0 != _tmp2_label2) ? _tmp2_label2 : (_tmp2_label2 = g_quark_from_static_string ("gnome-classic")))) || (_tmp3_ == ((0 != _tmp2_label3) ? _tmp2_label3 : (_tmp2_label3 = g_quark_from_static_string ("gnome-flashback-compiz"))))) || (_tmp3_ == ((0 != _tmp2_label4) ? _tmp2_label4 : (_tmp2_label4 = g_quark_from_static_string ("gnome-flashback-metacity"))))) || (_tmp3_ == ((0 != _tmp2_label5) ? _tmp2_label5 : (_tmp2_label5 = g_quark_from_static_string ("gnome-shell"))))) || (_tmp3_ == ((0 != _tmp2_label6) ? _tmp2_label6 : (_tmp2_label6 = g_quark_from_static_string ("gnome"))))) {
		switch (0) {
			default:
			{
				gchar* _tmp5_ = NULL;
	...
	} else if (((_tmp3_ == ((0 != _tmp2_label7) ? _tmp2_label7 : (_tmp2_label7 = g_quark_from_static_string ("kde")))) || (_tmp3_ == ((0 != _tmp2_label8) ? _tmp2_label8 : (_tmp2_label8 = g_quark_from_static_string ("kde-plasma"))))) || (_tmp3_ == ((0 != _tmp2_label9) ? _tmp2_label9 : (_tmp2_label9 = g_quark_from_static_string ("plasma"))))) {
		switch (0) {
			default:
			{
				gchar* _tmp6_ = NULL;
	...
	} else if (_tmp3_ == ((0 != _tmp2_label10) ? _tmp2_label10 : (_tmp2_label10 = g_quark_from_static_string ("xterm")))) {
		switch (0) {
			default:
			{
				gchar* _tmp7_ = NULL;
	...
	} else if (_tmp3_ == ((0 != _tmp2_label11) ? _tmp2_label11 : (_tmp2_label11 = g_quark_from_static_string ("remote-login")))) {
		switch (0) {
			default:
			{
				gchar* _tmp8_ = NULL;
...
GdkPixbuf* session_list_get_badge (const gchar* session) {
	...
	if (_tmp20_ == NULL) {
		...
		__catch20_g_error:
		{
			...
			g_debug ("session-list.vala:151: Error loading badge %s: %s", _tmp33_, _tmp35_);
			_g_error_free0 (e);
		}
		__finally20:
		if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void session_list_class_init (SessionListClass * klass) {
	...
	((GreeterListClass *) klass)->add_manual_entry = session_list_real_add_manual_entry;
	((GreeterListClass *) klass)->show_authenticated = session_list_real_show_authenticated;
