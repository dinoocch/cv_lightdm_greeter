/* prompt-box.c generated by valac 0.26.2, the Vala compiler
...
static void __lambda36_ (PromptBox* self, GtkWidget* w);
...
static void __lambda38_ (Block2Data* _data2_, const gchar* text);
static void ___lambda38__gfunc (gconstpointer data, gpointer self);
static Block3Data* block3_data_ref (Block3Data* _data3_);
static void block3_data_unref (void * _userdata_);
static void __lambda37_ (Block3Data* _data3_, GtkWidget* w);
...
static void __lambda39_ (Block4Data* _data4_, GtkWidget* w);
...
static gboolean __prompt_box___lambda40__gtk_widget_button_release_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
...
static void __active_indicator___lambda30__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
...
static GtkGrid* prompt_box_real_create_name_grid (PromptBox* self) {
	...
	gint _tmp32_ = 0;
	gint _tmp33_ = 0;
	FlatButton* _tmp34_ = NULL;
	FlatButton* _tmp35_ = NULL;
	FlatButton* _tmp36_ = NULL;
	AtkObject* _tmp37_ = NULL;
	const gchar* _tmp38_ = NULL;
	FlatButton* _tmp39_ = NULL;
	CachedImage* _tmp40_ = NULL;
	CachedImage* _tmp41_ = NULL;
	FlatButton* _tmp47_ = NULL;
	CachedImage* _tmp48_ = NULL;
	FlatButton* _tmp49_ = NULL;
	...
	__catch17_g_error:
	{
		...
		g_debug ("prompt-box.vala:193: Error loading message image: %s", _tmp23_);
		_g_error_free0 (e);
	}
	__finally17:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp31_ = self->box_grid;
	_tmp32_ = gtk_grid_get_column_spacing (_tmp31_);
	_tmp33_ = _tmp32_;
	gtk_widget_set_margin_top ((GtkWidget*) _tmp30_, ACTIVE_INDICATOR_WIDTH + _tmp33_);
	_tmp34_ = self->option_button;
	gtk_button_set_focus_on_click ((GtkButton*) _tmp34_, FALSE);
	_tmp35_ = self->option_button;
	gtk_button_set_relief ((GtkButton*) _tmp35_, GTK_RELIEF_NONE);
	...
	g_signal_connect_object ((GtkButton*) _tmp39_, "clicked", (GCallback) _prompt_box_option_button_clicked_cb_gtk_button_clicked, self, 0);
	_tmp40_ = cached_image_new (NULL);
	g_object_ref_sink (_tmp40_);
	_g_object_unref0 (self->priv->option_image);
	self->priv->option_image = _tmp40_;
	_tmp41_ = self->priv->option_image;
	gtk_widget_show ((GtkWidget*) _tmp41_);
	{
		GtkCssProvider* style = NULL;
		GtkCssProvider* _tmp42_ = NULL;
		FlatButton* _tmp43_ = NULL;
		...
		gtk_style_context_add_provider (_tmp44_, (GtkStyleProvider*) style, (guint) GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
		_g_object_unref0 (style);
	}
	goto __finally18;
	__catch18_g_error:
	{
		...
		g_debug ("prompt-box.vala:223: Internal error loading session chooser style: %s", _tmp46_);
		_g_error_free0 (e);
	}
	__finally18:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp48_ = self->priv->option_image;
	gtk_container_add ((GtkContainer*) _tmp47_, (GtkWidget*) _tmp48_);
	_tmp49_ = self->option_button;
	gtk_grid_attach (name_grid, (GtkWidget*) _tmp49_, PROMPT_BOX_COL_NAME_OPTIONS, PROMPT_BOX_ROW_NAME, 1, 1);
...
DashEntry* prompt_box_add_prompt (PromptBox* self, const gchar* text, const gchar* accessible_text, gboolean is_secret) {
	...
	if (_tmp3_) {
		...
		if (_tmp8_) {
			...
			_tmp16_ = placeholder;
			_tmp17_ = len;
			_tmp18_ = string_index_of_nth_char (_tmp16_, (glong) (_tmp17_ - 1));
			_tmp19_ = string_substring (_tmp15_, (glong) 0, (glong) _tmp18_);
			_g_free0 (placeholder);
			placeholder = _tmp19_;
		}
		_tmp20_ = entry;
		_tmp21_ = placeholder;
		dash_entry_set_constant_placeholder_text (_tmp20_, _tmp21_);
		_g_free0 (placeholder);
	}
	_tmp22_ = entry;
	...
	accessible = _tmp24_;
	_tmp25_ = accessible_text;
	if (_tmp25_ != NULL) {
		AtkObject* _tmp26_ = NULL;
		const gchar* _tmp27_ = NULL;
		_tmp26_ = accessible;
		_tmp27_ = accessible_text;
		atk_object_set_name (_tmp26_, _tmp27_);
	} else {
	...
	_tmp30_ = is_secret;
	if (_tmp30_) {
		DashEntry* _tmp31_ = NULL;
		DashEntry* _tmp32_ = NULL;
		_tmp31_ = entry;
		gtk_entry_set_visibility ((GtkEntry*) _tmp31_, FALSE);
		_tmp32_ = entry;
		g_object_set ((GtkEntry*) _tmp32_, "caps-lock-warning", TRUE, NULL);
	}
	_tmp33_ = entry;
	g_signal_connect_object (_tmp33_, "respond", (GCallback) _prompt_box_entry_activate_cb_dash_entry_respond, self, 0);
	_tmp34_ = entry;
	prompt_box_attach_item (self, (GtkWidget*) _tmp34_, TRUE);
	result = entry;
...
GtkComboBox* prompt_box_add_combo (PromptBox* self, GPtrArray* texts, gboolean read_only) {
	...
	_tmp14_ = texts;
	g_ptr_array_foreach (_tmp14_, ___lambda38__gfunc, _data2_);
	_tmp15_ = texts;
...
static void __lambda39_ (Block4Data* _data4_, GtkWidget* w) {
	...
	_data4_->best = _tmp2_;
	_tmp3_ = w;
	_tmp4_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp3_, gtk_entry_get_type ()) ? ((GtkEntry*) _tmp3_) : NULL);
	e = _tmp4_;
	_tmp5_ = w;
	_tmp6_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp5_, gtk_button_get_type ()) ? ((GtkButton*) _tmp5_) : NULL);
	b = _tmp6_;
	_tmp7_ = w;
	_tmp8_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp7_, gtk_combo_box_get_type ()) ? ((GtkComboBox*) _tmp7_) : NULL);
	c = _tmp8_;
	_tmp12_ = e;
	if (_tmp12_ != NULL) {
...
static GObject * prompt_box_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	g_signal_connect_object ((GtkWidget*) _tmp46_, "button-release-event", (GCallback) __prompt_box___lambda40__gtk_widget_button_release_event, self, 0);
...
static void prompt_box_class_init (PromptBoxClass * klass) {
	...
	((PromptBoxClass *) klass)->create_name_grid = prompt_box_real_create_name_grid;
	((PromptBoxClass *) klass)->create_small_name_grid = prompt_box_real_create_small_name_grid;
	((PromptBoxClass *) klass)->set_start_row = prompt_box_real_set_start_row;
	((PromptBoxClass *) klass)->reset_last_row = prompt_box_real_reset_last_row;
	((GtkWidgetClass *) klass)->get_preferred_height = prompt_box_real_get_preferred_height;
	((PromptBoxClass *) klass)->add_static_prompts = prompt_box_real_add_static_prompts;
	((GtkWidgetClass *) klass)->grab_focus = prompt_box_real_grab_focus;
	((GtkWidgetClass *) klass)->size_allocate = prompt_box_real_size_allocate;
	((FadableBoxClass *) klass)->draw_full_alpha = prompt_box_real_draw_full_alpha;
...
static gboolean active_indicator_real_draw (GtkWidget* base, cairo_t* c) {
	...
	_tmp1_ = c;
	_tmp2_ = GTK_WIDGET_CLASS (active_indicator_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_image_get_type (), GtkImage), _tmp1_);
	result = _tmp2_;
	return result;
}
...
static GObject * active_indicator_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	__catch19_g_error:
	{
		...
		g_debug ("prompt-box.vala:642: Could not load active image: %s", _tmp5_);
		_g_error_free0 (e);
	}
	__finally19:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void active_indicator_class_init (ActiveIndicatorClass * klass) {
	...
	((GtkWidgetClass *) klass)->get_preferred_width = active_indicator_real_get_preferred_width;
	((GtkWidgetClass *) klass)->get_preferred_height = active_indicator_real_get_preferred_height;
	((GtkWidgetClass *) klass)->draw = active_indicator_real_draw;
