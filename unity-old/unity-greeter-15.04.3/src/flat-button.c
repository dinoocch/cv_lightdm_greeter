/* flat-button.c generated by valac 0.26.2, the Vala compiler
...
static gboolean flat_button_real_button_press_event (GtkWidget* base, GdkEventButton* event);
static gboolean flat_button_real_button_release_event (GtkWidget* base, GdkEventButton* event);
...
static gboolean flat_button_real_draw (GtkWidget* base, cairo_t* c) {
	...
	_tmp0_ = c;
	_tmp1_ = GTK_WIDGET_CLASS (flat_button_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp0_);
	result = _tmp1_;
	return result;
}
...
static gboolean flat_button_real_button_release_event (GtkWidget* base, GdkEventButton* event) {
	...
	if (_tmp0_) {
		...
		_tmp1_ = event;
		_tmp1_->type = GDK_BUTTON_PRESS;
		_tmp2_ = event;
		GTK_WIDGET_CLASS (flat_button_parent_class)->button_press_event ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp2_);
		self->priv->did_press = FALSE;
	}
	_tmp3_ = event;
	_tmp3_->type = GDK_BUTTON_RELEASE;
	_tmp4_ = event;
	_tmp5_ = GTK_WIDGET_CLASS (flat_button_parent_class)->button_release_event ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_button_get_type (), GtkButton), _tmp4_);
	result = _tmp5_;
	return result;
}
...
static void flat_button_class_init (FlatButtonClass * klass) {
	...
	((GtkWidgetClass *) klass)->draw = flat_button_real_draw;
	((GtkWidgetClass *) klass)->button_press_event = flat_button_real_button_press_event;
	((GtkWidgetClass *) klass)->button_release_event = flat_button_real_button_release_event;
