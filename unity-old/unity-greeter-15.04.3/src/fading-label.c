/* fading-label.c generated by valac 0.26.2, the Vala compiler
...
static void fading_label_real_get_preferred_width_for_height (GtkWidget* base, gint height, gint* minimum, gint* natural) {
	...
	self = (FadingLabel*) base;
	_tmp0_ = height;
	GTK_WIDGET_CLASS (fading_label_parent_class)->get_preferred_width_for_height ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_label_get_type (), GtkLabel), _tmp0_, &_tmp1_, &_tmp2_);
...
static cairo_surface_t* fading_label_make_surface (FadingLabel* self, cairo_t* orig_c) {
	...
	if (_tmp12_ > _tmp13_) {
		...
		_tmp15_ = c;
		GTK_WIDGET_CLASS (fading_label_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_label_get_type (), GtkLabel), _tmp15_);
		_tmp16_ = c;
		...
		_tmp26_ = c;
		GTK_WIDGET_CLASS (fading_label_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_label_get_type (), GtkLabel), _tmp26_);
	}
	result = surface;
	_cairo_destroy0 (c);
	return result;
...
static void fading_label_class_init (FadingLabelClass * klass) {
	...
	((GtkWidgetClass *) klass)->get_preferred_width = fading_label_real_get_preferred_width;
	((GtkWidgetClass *) klass)->get_preferred_width_for_height = fading_label_real_get_preferred_width_for_height;
	((GtkWidgetClass *) klass)->size_allocate = fading_label_real_size_allocate;
	((GtkWidgetClass *) klass)->draw = fading_label_real_draw;
