/* menubar.c generated by valac 0.26.2, the Vala compiler
...
static gint __lambda15_ (IndicatorObject* a, IndicatorObject* b);
...
IndicatorMenuItem* indicator_menu_item_construct (GType object_type, IndicatorObjectEntry* entry) {
	...
	if (_tmp28_ != NULL) {
		...
		gtk_menu_item_set_submenu ((GtkMenuItem*) self, G_TYPE_CHECK_INSTANCE_TYPE (_tmp30_, gtk_widget_get_type ()) ? ((GtkWidget*) _tmp30_) : NULL);
	}
...
gboolean indicator_menu_item_has_visible_child (IndicatorMenuItem* self) {
	...
	if (_tmp1_) {
		...
		_tmp9_ = _tmp8_->label;
		if (_tmp9_ != NULL) {
			IndicatorObjectEntry* _tmp10_ = NULL;
...
static GtkWidget* menu_bar_make_a11y_indicator (MenuBar* self) {
	...
	_tmp7_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp6_, gtk_widget_get_type ()) ? ((GtkWidget*) _tmp6_) : NULL;
	if (_tmp7_ == NULL) {
	...
	gtk_widget_add_accelerator ((GtkWidget*) item, "activate", _tmp27_, (guint) GDK_KEY_s, GDK_SUPER_MASK | GDK_MOD1_MASK, GTK_ACCEL_VISIBLE);
...
static IndicatorObject* menu_bar_load_indicator_file (MenuBar* self, const gchar* indicator_name) {
	...
	__catch12_g_error:
	{
		...
		_error_ = _inner_error_;
		_inner_error_ = NULL;
		_tmp17_ = indicator_name;
		_tmp18_ = _error_;
		_tmp19_ = _tmp18_->message;
		g_warning ("menubar.vala:263: unable to load %s: %s", _tmp17_, _tmp19_);
		result = NULL;
		_g_error_free0 (_error_);
		_g_object_unref0 (io);
		_g_free0 (path);
...
static void menu_bar_setup_indicators (MenuBar* self) {
	...
	update_indicator_list = FALSE;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (g_strcmp0 (_tmp14_, "ug-keyboard") == 0) {
					gchar** _tmp15_ = NULL;
					...
					_tmp16_ = i;
					_tmp17_ = g_strdup ("com.canonical.indicator.keyboard");
	...
	_tmp19_ = update_indicator_list;
	if (_tmp19_) {
		gchar** _tmp20_ = NULL;
		gint _tmp20__length1 = 0;
		_tmp20_ = indicator_list;
		_tmp20__length1 = indicator_list_length1;
		ug_settings_set_strv (UG_SETTINGS_KEY_INDICATORS, _tmp20_, _tmp20__length1);
	}
	...
	_tmp21__length1 = indicator_list_length1;
	{
		...
		gint indicator_it = 0;
		indicator_collection = _tmp21_;
		indicator_collection_length1 = _tmp21__length1;
		for (indicator_it = 0; indicator_it < _tmp21__length1; indicator_it = indicator_it + 1) {
			gchar* _tmp22_ = NULL;
			gchar* indicator = NULL;
			_tmp22_ = g_strdup (indicator_collection[indicator_it]);
			indicator = _tmp22_;
			{
				const gchar* _tmp23_ = NULL;
				_tmp23_ = indicator;
				menu_bar_load_indicator (self, _tmp23_);
				_g_free0 (indicator);
			}
		}
	}
	self->priv->indicator_objects = g_list_sort (self->priv->indicator_objects, ___lambda15__gcompare_func);
	_tmp24_ = g_getenv ("LANG");
	_tmp25_ = g_getenv ("LANGUAGE");
	g_debug ("menubar.vala:367: LANG=%s LANGUAGE=%s", _tmp24_, _tmp25_);
...
static void menu_bar_class_init (MenuBarClass * klass) {
	...
	((GtkWidgetClass *) klass)->draw = menu_bar_real_draw;
	((GtkWidgetClass *) klass)->get_preferred_height = menu_bar_real_get_preferred_height;
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), MENU_BAR_KEYBOARD_WINDOW, g_param_spec_object ("keyboard-window", "keyboard-window", "keyboard-window", gtk_window_get_type (), G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), MENU_BAR_ACCEL_GROUP, g_param_spec_object ("accel-group", "accel-group", "accel-group", gtk_accel_group_get_type (), G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
}
