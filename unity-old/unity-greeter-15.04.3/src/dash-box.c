/* dash-box.c generated by valac 0.26.2, the Vala compiler
...
static void ____lambda42__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
...
void dash_box_set_base (DashBox* self, GtkWidget* w) {
	...
	if (_tmp2_ != NULL) {
		...
		g_signal_parse_name ("size-allocate", gtk_widget_get_type (), &_tmp4_, NULL, FALSE);
	...
	if (_tmp7_ != NULL) {
		...
		g_signal_connect_object ((GObject*) _tmp11_, "notify::alpha", (GCallback) ____lambda42__g_object_notify, self, 0);
...
static gboolean dash_box_real_draw (GtkWidget* base, cairo_t* c) {
	...
	_tmp37_ = c;
	_tmp38_ = GTK_WIDGET_CLASS (dash_box_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_box_get_type (), GtkBox), _tmp37_);
	result = _tmp38_;
	return result;
}
...
static void dash_box_class_init (DashBoxClass * klass) {
	...
	((GtkWidgetClass *) klass)->get_preferred_height = dash_box_real_get_preferred_height;
	((GtkWidgetClass *) klass)->get_preferred_width = dash_box_real_get_preferred_width;
	((GtkWidgetClass *) klass)->draw = dash_box_real_draw;
