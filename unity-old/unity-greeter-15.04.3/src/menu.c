/* menu.c generated by valac 0.26.2, the Vala compiler
...
static gboolean menu_real_draw (GtkWidget* base, cairo_t* c) {
	...
	_tmp17_ = c;
	GTK_WIDGET_CLASS (menu_parent_class)->draw ((GtkWidget*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_menu_get_type (), GtkMenu), _tmp17_);
	result = FALSE;
	return result;
}
...
static void menu_class_init (MenuClass * klass) {
	...
	((GtkWidgetClass *) klass)->draw = menu_real_draw;
