/* list-stack.c generated by valac 0.26.2, the Vala compiler
...
static void list_stack_class_init (ListStackClass * klass) {
	...
	((GtkWidgetClass *) klass)->size_allocate = list_stack_real_size_allocate;
	((GtkWidgetClass *) klass)->get_preferred_width = list_stack_real_get_preferred_width;
