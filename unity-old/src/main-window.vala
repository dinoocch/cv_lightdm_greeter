...
public class MainWindow : Gtk.Window
{
    ...
    construct
    {
        ...
        background.show ();
        add (background);
        CvGreeter.add_style_class (background);
        ...
        CvGreeter.add_style_class (menualign);
        CvGreeter.add_style_class (menubox);

        menubar = new MenuBar (background, accel_group);
        menubar.show ();
        menualign.add (menubar);
        CvGreeter.add_style_class (menubar);
    ...
    private void add_user_list ()
    {
        ...
        greeter_list.show ();
        CvGreeter.add_style_class (greeter_list);
    ...
    public override bool key_press_event (Gdk.EventKey event)
    {
        ...
        case Gdk.Key.PowerOff:
            ...
            return true;
        case Gdk.Key.z:
            if (CvGreeter.singleton.test_mode && (event.state & Gdk.ModifierType.MOD1_MASK) != 0)
            {
                show_shutdown_dialog (ShutdownDialogType.SHUTDOWN);
                return true;
            }
